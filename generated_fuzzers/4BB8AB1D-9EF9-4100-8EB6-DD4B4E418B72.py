...
class ('_ADATTRIBUTEDATA', None)(NdrStructure):
    MEMBERS = [(('LONG', None), "operation"),(('BSTR', None), "attributeName"),(('BSTR', None), "attributeValue"),(('VARIANT_BOOL', None), "isString"),(('LONG', None), "length"),]

    

class ('_VERSIONVECTORDATA', None)(NdrStructure):
    MEMBERS = [(('LONG', None), "uncompressedSize"),(('LONG', None), "backlogCount"),(('BSTR', None), "contentSetGuid"),(('VARIANT', None), "versionVector"),]
