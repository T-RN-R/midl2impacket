...
class DFSRHELPERERRORSENUM(NdrEnum):
    MAP = ((2147753985 , 'dfsrHelperErrorNotLocalAdmin'),(2147753986 , 'dfsrHelperErrorCreateVerifyServerControl'),(2147758080 , 'dfsrHelperLdapErrorBase'),)        

class DFSRREPORTINGFLAGS(NdrEnum):
    MAP = ((0 , 'REPORTING_FLAGS_NONE'),(1 , 'REPORTING_FLAGS_BACKLOG'),(2 , 'REPORTING_FLAGS_FILES'),)        

class _ADATTRIBUTEDATA(NdrStructure):
    MEMBERS = [(LONG, "operation"),(BSTR, "attributeName"),(BSTR, "attributeValue"),(VARIANT_BOOL, "isString"),(LONG, "length"),]

    

class _VERSIONVECTORDATA(NdrStructure):
    MEMBERS = [(LONG, "uncompressedSize"),(LONG, "backlogCount"),(BSTR, "contentSetGuid"),(VARIANT, "versionVector"),]

    
Interface("4BB8AB1D-9EF9-4100-8EB6-DD4B4E418B72", "1.0",[Method("CreateObject",
In((BSTR,'domainControllerName')),
In((BSTR,'distinguishedName')),
In((PPSAFEARRAY,'attributes')),
