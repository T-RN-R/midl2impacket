...
class FW_OBJECT_METADATA(NdrStructure):
    MEMBERS = [
        ...
        (DWORD, "dwNumEntries"),
        (PFW_ENFORCEMENT_STATE, "pEnforcementStates"),
    ]
...
class FW_RULE2_20(NdrStructure):
    MEMBERS = [
        ...
        (DWORD, "Reserved"),
        (PFW_OBJECT_METADATA, "pMetaData"),
        (PWCHAR, "wszLocalUserAuthorizationList"),
        (PWCHAR, "wszPackageId"),
        (PWCHAR, "wszLocalUserOwner"),
...
class FW_RULE2_27(NdrStructure):
    MEMBERS = [
        (PPNEXT, "*pNext"),
        (UNSIGNED_SHORT, "wSchemaVersion"),
        (PWCHAR_T, "wszRuleId"),
        (PWCHAR_T, "wszName"),
        (PWCHAR_T, "wszDescription"),
        (UNSIGNED_LONG, "dwProfiles"),
        (FW_DIRECTION, "Direction"),
        (UNSIGNED_SHORT, "wIpProtocol"),
        (U0, "u0"),
        (FW_ADDRESSES, "LocalAddresses"),
        (FW_ADDRESSES, "RemoteAddresses"),
        (FW_INTERFACE_LUIDS, "LocalInterfaceIds"),
        (UNSIGNED_LONG, "dwLocalInterfaceTypes"),
        (PWCHAR_T, "wszLocalApplication"),
        (PWCHAR_T, "wszLocalService"),
        (FW_RULE_ACTION, "Action"),
        (UNSIGNED_SHORT, "wFlags"),
        (PWCHAR_T, "wszRemoteMachineAuthorizationList"),
        (PWCHAR_T, "wszRemoteUserAuthorizationList"),
        (PWCHAR_T, "wszEmbeddedContext"),
        (FW_OS_PLATFORM_LIST, "PlatformValidityList"),
        (FW_RULE_STATUS, "Status"),
        (FW_RULE_ORIGIN_TYPE, "Origin"),
        (PWCHAR_T, "wszGPOName"),
        ...
        (PWCHAR, "wszPackageId"),
        (PWCHAR, "wszLocalUserOwner"),
        (UNSIGNED_LONG, "dwTrustTupleKeywords"),
        (FW_NETWORK_NAMES, "OnNetworkNames"),
        (PWCHAR, "wszSecurityRealmId"),
        (UNSIGNED_SHORT, "wFlags2"),
        (FW_NETWORK_NAMES, "RemoteOutServerNames"),
        (PWCHAR, "wszFqbn"),
        (UNSIGNED_LONG, "compartmentId"),
    ]
...
class FW_PRODUCT(NdrStructure):
    MEMBERS = [
        ...
        (PFW_RULE_CATEGORY, "pRuleCategories"),
        (PWCHAR_T, "pszDisplayName"),
        (PWCHAR_T, "pszPathToSignedProductExe"),
    ]
...
class FW_CS_RULE2_0(NdrStructure):
    MEMBERS = [
        ...
        (BYTE, "LocalTunnelEndpointV6"),
        (DWORD, "dwRemoteTunnelEndpointV4"),
        (BYTE, "RemoteTunnelEndpointV6"),
        (FW_PORTS, "Endpoint1Ports"),
        (FW_PORTS, "Endpoint2Ports"),
        (WORD, "wIpProtocol"),
        (PWCHAR, "wszPhase1AuthSet"),
        (PWCHAR, "wszPhase2CryptoSet"),
        (PWCHAR, "wszPhase2AuthSet"),
...
class FW_CS_RULE(NdrStructure):
    MEMBERS = [
        ...
        (DWORD, "Reserved"),
        (PFW_OBJECT_METADATA, "pMetaData"),
        (PWCHAR, "wszRemoteTunnelEndpointFqdn"),
...
class FW_ENDPOINTS(NdrStructure):
    MEMBERS = [
        ...
        (BYTE, "SourceV6Address"),
        (BYTE, "DestinationV6Address"),
    ]
...
class FW_PROFILE_CONFIG_VALUE(NdrUnion):
    ...
    MEMBERS = {
        1: (PWCHAR, "wszStr"),
        2: (PFW_INTERFACE_LUIDS, "pDisabledInterfaces"),
        3: (PDWORD, "pdwVal"),
    }
...
class FW_QUERY_CONDITIONS(NdrStructure):
    MEMBERS = [
        (DWORD, "dwNumEntries"),
        (PFW_QUERY_CONDITION, "AndedConditions"),
    ]
...
class FW_QUERY(NdrStructure):
    MEMBERS = [
        (WORD, "wSchemaVersion"),
        (UINT32, "dwNumEntries"),
        (PFW_QUERY_CONDITIONS, "ORConditions"),
        (FW_RULE_STATUS, "Status"),
    ]
