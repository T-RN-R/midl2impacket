...
class FW_PROFILE_TYPE(NdrEnum):
    MAP = ((0 , 'FW_PROFILE_TYPE_INVALID'),(1 , 'FW_PROFILE_TYPE_DOMAIN'),(2 , 'FW_PROFILE_TYPE_STANDARD'),(FW_PROFILE_TYPE_STANDARD , 'FW_PROFILE_TYPE_PRIVATE'),(4 , 'FW_PROFILE_TYPE_PUBLIC'),(2147483647 , 'FW_PROFILE_TYPE_ALL'),(2147483648 , 'FW_PROFILE_TYPE_CURRENT'),(FW_PROFILE_TYPE_CURRENT+1 , 'FW_PROFILE_TYPE_NONE'),)        
...
class FW_AUTH_SET2_10(NdrStructure):
    MEMBERS = [(P_TAG_FW_AUTH_SET2_10, "pNext"),(WORD, "wSchemaVersion"),(FW_IPSEC_PHASE, "IpSecPhase"),(PWCHAR, "wszSetId"),(PWCHAR, "wszName"),(PWCHAR, "wszDescription"),(PWCHAR, "wszEmbeddedContext"),(DWORD, "dwNumSuites"),(PFW_AUTH_SUITE2_10, "pSuites"),(FW_RULE_ORIGIN_TYPE, "Origin"),(PWCHAR, "wszGPOName"),(FW_RULE_STATUS, "Status"),(DWORD, "dwAuthSetFlags"),]

    
PFW_AUTH_SET2_10 = FW_AUTH_SET2_10

class FW_AUTH_SET(NdrStructure):
    MEMBERS = [(P_TAG_FW_AUTH_SET, "pNext"),(WORD, "wSchemaVersion"),(FW_IPSEC_PHASE, "IpSecPhase"),(PWCHAR, "wszSetId"),(PWCHAR, "wszName"),(PWCHAR, "wszDescription"),(PWCHAR, "wszEmbeddedContext"),(DWORD, "dwNumSuites"),(PFW_AUTH_SUITE, "pSuites"),(FW_RULE_ORIGIN_TYPE, "Origin"),(PWCHAR, "wszGPOName"),(FW_RULE_STATUS, "Status"),(DWORD, "dwAuthSetFlags"),]
...
class FW_CRYPTO_PROTOCOL_TYPE(NdrEnum):
    MAP = ((0 , 'FW_CRYPTO_PROTOCOL_INVALID'),(1 , 'FW_CRYPTO_PROTOCOL_AH'),(2 , 'FW_CRYPTO_PROTOCOL_ESP'),(3 , 'FW_CRYPTO_PROTOCOL_BOTH'),(4 , 'FW_CRYPTO_PROTOCOL_AUTH_NO_ENCAP'),(5 , 'FW_CRYPTO_PROTOCOL_MAX'),((FW_CRYPTO_PROTOCOL_BOTH+1) , 'FW_CRYPTO_PROTOCOL_MAX_2_1'),)        
...
class FW_CRYPTO_SET(NdrStructure):
    MEMBERS = [(P_TAG_FW_CRYPTO_SET, "pNext"),(WORD, "wSchemaVersion"),(FW_IPSEC_PHASE, "IpSecPhase"),(PWCHAR, "wszSetId"),(PWCHAR, "wszName"),(PWCHAR, "wszDescription"),(PWCHAR, "wszEmbeddedContext"),(U0, "u0"),(FW_RULE_ORIGIN_TYPE, "Origin"),(PWCHAR, "wszGPOName"),(FW_RULE_STATUS, "Status"),(DWORD, "dwCryptoSetFlags"),]
