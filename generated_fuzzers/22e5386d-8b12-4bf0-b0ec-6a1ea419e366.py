...
class EVENT_BUFFER(NdrStructure):
    MEMBERS = [(UNSIGNED_LONG, "BufferLength"),(PBYTE, "Buffer"),]

    
Interface("22e5386d-8b12-4bf0-b0ec-6a1ea419e366", "1.0",[Method("RpcNetEventOpenSession",
In((HANDLE_T,'BindingHandle')),
In((PWCHAR_T,'LoggerName')),
Out((PPSESSION_HANDLE,'SessionHandle')),
),Method("RpcNetEventReceiveData",
In((PSESSION_HANDLE,'SessionHandle')),
Out((PEVENT_BUFFER,'EventBuffer')),
),Method("RpcNetEventCloseSession",
InOut((PPSESSION_HANDLE,'SessionHandle')),
),])