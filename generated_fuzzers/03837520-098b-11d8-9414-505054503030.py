...
class DATACOLLECTORTYPE(NdrEnum):
    MAP = ((0 , 'plaPerformanceCounter'),(1 , 'plaTrace'),(2 , 'plaConfiguration'),(3 , 'plaAlert'),(4 , 'plaApiTrace'),)        

class FILEFORMAT(NdrEnum):
    MAP = ((0 , 'plaCommaSeparated'),(1 , 'plaTabSeparated'),(2 , 'plaSql'),(3 , 'plaBinary'),)        

class AUTOPATHFORMAT(NdrEnum):
    MAP = ((0 , 'plaNone'),(1 , 'plaPattern'),(2 , 'plaComputer'),(256 , 'plaMonthDayHour'),(512 , 'plaSerialNumber'),(1024 , 'plaYearDayOfYear'),(2048 , 'plaYearMonth'),(4096 , 'plaYearMonthDay'),(8192 , 'plaYearMonthDayHour'),(16384 , 'plaMonthDayHourMinute'),)        

class DATACOLLECTORSETSTATUS(NdrEnum):
    MAP = ((0 , 'plaStopped'),(1 , 'plaRunning'),(2 , 'plaCompiling'),(3 , 'plaPending'),(4 , 'plaUndefined'),)        

class CLOCKTYPE(NdrEnum):
    MAP = ((0 , 'plaTimeStamp'),(1 , 'plaPerformance'),(2 , 'plaSystem'),(3 , 'plaCycle'),)        

class STREAMMODE(NdrEnum):
    MAP = ((1 , 'plaFile'),(2 , 'plaRealTime'),(3 , 'plaBoth'),(4 , 'plaBuffering'),)        

class COMMITMODE(NdrEnum):
    MAP = ((1 , 'plaCreateNew'),(2 , 'plaModify'),(3 , 'plaCreateOrModify'),(16 , 'plaUpdateRunningInstance'),(32 , 'plaFlushTrace'),(4096 , 'plaValidateOnly'),)        

class VALUEMAPTYPE(NdrEnum):
    MAP = ((1 , 'plaIndex'),(2 , 'plaFlag'),(3 , 'plaFlagArray'),(4 , 'plaValidation'),)        

class WEEKDAYS(NdrEnum):
    MAP = ((0 , 'plaRunOnce'),(1 , 'plaSunday'),(2 , 'plaMonday'),(4 , 'plaTuesday'),(8 , 'plaWednesday'),(16 , 'plaThursday'),(32 , 'plaFriday'),(64 , 'plaSaturday'),(127 , 'plaEveryday'),)        

class RESOURCEPOLICY(NdrEnum):
    MAP = ((0 , 'plaDeleteLargest'),(1 , 'plaDeleteOldest'),)        

class DATAMANAGERSTEPS(NdrEnum):
    MAP = ((1 , 'plaCreateReport'),(2 , 'plaRunRules'),(4 , 'plaCreateHtml'),(8 , 'plaFolderActions'),(16 , 'plaResourceFreeing'),)        

class FOLDERACTIONSTEPS(NdrEnum):
    MAP = ((1 , 'plaCreateCab'),(2 , 'plaDeleteData'),(4 , 'plaSendCab'),(8 , 'plaDeleteCab'),(16 , 'plaDeleteReport'),)        
Interface("03837520-098b-11d8-9414-505054503030", "1.0",[Method("DataCollectors",
Out((PPIDATACOLLECTORCOLLECTION,'collectors')),
),Method("Duration",
Out((PUNSIGNED_LONG,'seconds')),
),Method("Duration",
In((UNSIGNED_LONG,'seconds')),
),Method("Description",
...
Out((PBSTR,'DisplayName')),
),Method("DisplayName",
In((BSTR,'DisplayName')),
),Method("DisplayNameUnresolved",
Out((PBSTR,'name')),
),Method("Keywords",
Out((PSAFEARRAY,'keywords')),
),Method("Keywords",
In((SAFEARRAY,'keywords')),
...
Out((PDATACOLLECTORSETSTATUS,'status')),
),Method("Subdirectory",
Out((PBSTR,'folder')),
),Method("Subdirectory",
In((BSTR,'folder')),
),Method("SubdirectoryFormat",
Out((PAUTOPATHFORMAT,'format')),
),Method("SubdirectoryFormat",
...
Out((PPISCHEDULECOLLECTION,'ppSchedules')),
),Method("SchedulesEnabled",
Out((PVARIANT_BOOL,'enabled')),
),Method("SchedulesEnabled",
...
Out((PBSTR,'pbstrSecurity')),
),Method("Security",
In((BSTR,'bstrSecurity')),
),Method("StopOnCompletion",
Out((PVARIANT_BOOL,'Stop')),
),Method("StopOnCompletion",
In((VARIANT_BOOL,'Stop')),
),Method("DataManager",
Out((PPIDATAMANAGER,'DataManager')),
