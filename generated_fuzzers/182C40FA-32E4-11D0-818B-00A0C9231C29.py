...
class ('PROPERTYMETA', None)(NdrStructure):
    MEMBERS = [(('DWORD', None), "dataType"),(('ULONG', None), "cbSize"),(('DWORD', None), "flags"),]

    

class ('SRPLEVELINFO', None)(NdrStructure):
    MEMBERS = [(('DWORD', None), "dwSRPLevel"),(('PWCHAR', None), "wszFriendlyName"),]

    

class ('INSTANCECONTAINER', None)(NdrStructure):
    MEMBERS = [(('GUID', None), "ConglomerationID"),(('GUID', None), "PartitionID"),(('GUID', None), "ContainerID"),(('DWORD', None), "dwProcessID"),(('BOOL', None), "bPaused"),(('BOOL', None), "bRecycled"),]
