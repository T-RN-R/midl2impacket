...
class PROPERTYMETA(NdrStructure):
    MEMBERS = [(DWORD, "dataType"),(ULONG, "cbSize"),(DWORD, "flags"),]

    

class ECOMPONENTTYPE(NdrEnum):
    MAP = ((0 , 'eCT_UNKNOWN'),(1 , 'eCT_32BIT'),(2 , 'eCT_64BIT'),(4096 , 'eCT_NATIVE'),)        

class SRPLEVELINFO(NdrStructure):
    MEMBERS = [(DWORD, "dwSRPLevel"),(PWCHAR, "wszFriendlyName"),]
...
class CATSRVSERVICESTATE(NdrEnum):
    MAP = ((0 , 'css_serviceStopped'),(1 , 'css_serviceStartPending'),(2 , 'css_serviceStopPending'),(3 , 'css_serviceRunning'),(4 , 'css_serviceContinuePending'),(5 , 'css_servicePausePending'),(6 , 'css_servicePaused'),(7 , 'css_serviceUnknownState'),)        

class INSTANCECONTAINER(NdrStructure):
    MEMBERS = [(GUID, "ConglomerationID"),(GUID, "PartitionID"),(GUID, "ContainerID"),(DWORD, "dwProcessID"),(BOOL, "bPaused"),(BOOL, "bRecycled"),]

    
Interface("182C40FA-32E4-11D0-818B-00A0C9231C29", "1.0",[Method("Opnum3NotUsedOnWire",
...
In((FLOAT,'flVerUpper')),
In((LONG,'reserved')),
Out((PFLOAT,'pflVerSession')),
),Method("GetServerInformation",
Out((PLONG,'plReserved1')),
Out((PLONG,'plReserved2')),
Out((PLONG,'plReserved3')),
Out((PLONG,'plMultiplePartitionSupport')),
Out((PLONG,'plReserved4')),
Out((PLONG,'plReserved5')),
),])