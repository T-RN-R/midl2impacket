...
PPMETADATA_HANDLE = UNSIGNED_LONG

class IIS_CRYPTO_BLOB(NdrStructure):
    MEMBERS = [(DWORD, "BlobSignature"),(DWORD, "BlobDataLength"),(UNSIGNED_CHAR, "BlobData"),]

    

class METADATA_RECORD(NdrStructure):
    MEMBERS = [(DWORD, "dwMDIdentifier"),(DWORD, "dwMDAttributes"),(DWORD, "dwMDUserType"),(DWORD, "dwMDDataType"),(DWORD, "dwMDDataLen"),(PUNSIGNED_CHAR, "pbMDData"),(DWORD, "dwMDDataTag"),]

    

class METADATA_GETALL_RECORD(NdrStructure):
    MEMBERS = [(DWORD, "dwMDIdentifier"),(DWORD, "dwMDAttributes"),(DWORD, "dwMDUserType"),(DWORD, "dwMDDataType"),(DWORD, "dwMDDataLen"),(DWORD, "dwMDDataOffset"),(DWORD, "dwMDDataTag"),]

    
PMETADATA_GETALL_RECORD = METADATA_GETALL_RECORD

class METADATA_HANDLE_INFO(NdrStructure):
    MEMBERS = [(DWORD, "dwMDPermissions"),(DWORD, "dwMDSystemChangeNumber"),]

    
Interface("70B51430-B6CA-11d0-B9B9-00A0C922E750", "1.0",[Method("AddKey",
...
In((METADATA_HANDLE,'hMDHandle')),
In((LPCWSTR,'pszMDPath')),
Out((LPWSTR,'pszMDName')),
In((DWORD,'dwMDEnumObjectIndex')),
),Method("CopyKey",
In((METADATA_HANDLE,'hMDSourceHandle')),
In((LPCWSTR,'pszMDSourcePath')),
In((METADATA_HANDLE,'hMDDestHandle')),
In((LPCWSTR,'pszMDDestPath')),
In((BOOL,'bMDOverwriteFlag')),
In((BOOL,'bMDCopyFlag')),
),Method("RenameKey",
In((METADATA_HANDLE,'hMDHandle')),
In((LPCWSTR,'pszMDPath')),
In((LPCWSTR,'pszMDNewName')),
),Method("R_SetData",
In((METADATA_HANDLE,'hMDHandle')),
In((LPCWSTR,'pszMDPath')),
...
In((METADATA_HANDLE,'hMDHandle')),
In((LPCWSTR,'pszMDPath')),
InOut((PMETADATA_RECORD,'pmdrMDData')),
Out((PDWORD,'pdwMDRequiredDataLen')),
Out((PPIIS_CRYPTO_BLOB,'ppDataBlob')),
),Method("DeleteData",
In((METADATA_HANDLE,'hMDHandle')),
In((LPCWSTR,'pszMDPath')),
...
Out((PDWORD,'pdwMDRequiredBufferSize')),
Out((PPIIS_CRYPTO_BLOB,'ppDataBlob')),
...
Out((PDWORD,'pdwSystemChangeNumber')),
...
Out((PPIIS_CRYPTO_BLOB,'ppServerKeyExchangeKeyBlob')),
Out((PPIIS_CRYPTO_BLOB,'ppServerSignatureKeyBlob')),
Out((PPIIS_CRYPTO_BLOB,'ppServerSessionKeyBlob')),
),Method("R_KeyExchangePhase2",
In((PIIS_CRYPTO_BLOB,'pClientSessionKeyBlob')),
In((PIIS_CRYPTO_BLOB,'pClientHashBlob')),
Out((PPIIS_CRYPTO_BLOB,'ppServerHashBlob')),
),Method("Backup",
In((LPCWSTR,'pszMDBackupName')),
...
InOut((LPWSTR,'pszMDBackupName')),
Out((PDWORD,'pdwMDVersion')),
...
Out((PPIMSADMINBASEW,'piadmbwInterface')),
),Method("R_GetServerGuid",
Out((PGUID,'pServerGuid')),
),])