...
Method("AddKey", In(METADATA_HANDLE), In(LPCWSTR),), Method(
    "DeleteKey",
    In(METADATA_HANDLE),
    In(LPCWSTR),
), Method("DeleteChildKeys", In(METADATA_HANDLE), In(LPCWSTR),), Method(
    "EnumKeys",
    In(METADATA_HANDLE),
    In(LPCWSTR),
    Out(LPWSTR),
