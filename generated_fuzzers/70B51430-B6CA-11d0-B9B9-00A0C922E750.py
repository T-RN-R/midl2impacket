...
class ('IIS_CRYPTO_BLOB', None)(NdrStructure):
    MEMBERS = [(('DWORD', None), "BlobSignature"),(('DWORD', None), "BlobDataLength"),(('UNSIGNED_CHAR', None), "BlobData"),]

    

class ('METADATA_RECORD', None)(NdrStructure):
    MEMBERS = [(('DWORD', None), "dwMDIdentifier"),(('DWORD', None), "dwMDAttributes"),(('DWORD', None), "dwMDUserType"),(('DWORD', None), "dwMDDataType"),(('DWORD', None), "dwMDDataLen"),(('PUNSIGNED_CHAR', None), "pbMDData"),(('DWORD', None), "dwMDDataTag"),]

    

class ('METADATA_GETALL_RECORD', None)(NdrStructure):
    MEMBERS = [(('DWORD', None), "dwMDIdentifier"),(('DWORD', None), "dwMDAttributes"),(('DWORD', None), "dwMDUserType"),(('DWORD', None), "dwMDDataType"),(('DWORD', None), "dwMDDataLen"),(('DWORD', None), "dwMDDataOffset"),(('DWORD', None), "dwMDDataTag"),]

    

class ('METADATA_HANDLE_INFO', None)(NdrStructure):
    MEMBERS = [(('DWORD', None), "dwMDPermissions"),(('DWORD', None), "dwMDSystemChangeNumber"),]
