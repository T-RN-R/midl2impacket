...
class DSROLER_PRIMARY_DOMAIN_INFO_BASIC(NdrStructure):
    MEMBERS = [(DSROLE_MACHINE_ROLE, "MachineRole"),(UNSIGNED___INT32, "Flags"),(PWCHAR_T, "DomainNameFlat"),(PWCHAR_T, "DomainNameDns"),(PWCHAR_T, "DomainForestName"),(GUID, "DomainGuid"),]

    
PDSROLER_PRIMARY_DOMAIN_INFO_BASIC = DSROLER_PRIMARY_DOMAIN_INFO_BASIC

class DSROLER_PRIMARY_DOMAIN_INFORMATION(NdrUnion):
    SWITCHTYPE = DWORD
    MEMBERS = {1 : (DSROLER_PRIMARY_DOMAIN_INFO_BASIC, "DomainInfoBasic"),2 : (DSROLE_UPGRADE_STATUS_INFO, "UpgradStatusInfo"),3 : (DSROLE_OPERATION_STATE_INFO, "OperationStateInfo"),}
