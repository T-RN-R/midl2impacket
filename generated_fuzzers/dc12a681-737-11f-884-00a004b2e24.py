...
class _WBEM_REFRESH_INFO_REMOTE(NdrStructure):
    MEMBERS = [
        (PIWBEMREMOTEREFRESHER, "m_pRefresher"),
        (PIWBEMCLASSOBJECT, "m_pTemplate"),
        (GUID, "m_Guid"),
    ]
...
class WBEM_REFRESH_INFO_UNION(NdrUnion):
    SWITCHTYPE = DWORD
    MEMBERS = {
        1: (_WBEM_REFRESH_INFO_REMOTE, "m_Remote"),
        2: (_WBEM_REFRESH_INFO_NON_HIPERF, "m_NonHiPerf"),
        3: (HRESULT, "m_hres"),
    }
