...
class WBEM_QUERY_FLAG_TYPE(NdrEnum):
    MAP = ((0 , 'WBEM_FLAG_DEEP'),(1 , 'WBEM_FLAG_SHALLOW'),(2 , 'WBEM_FLAG_PROTOTYPE'),)        

class WBEM_CHANGE_FLAG_TYPE(NdrEnum):
    MAP = ((0 , 'WBEM_FLAG_CREATE_OR_UPDATE'),(1 , 'WBEM_FLAG_UPDATE_ONLY'),(2 , 'WBEM_FLAG_CREATE_ONLY'),(32 , 'WBEM_FLAG_UPDATE_SAFE_MODE'),(64 , 'WBEM_FLAG_UPDATE_FORCE_MODE'),)        

class WBEM_CONNECT_OPTIONS(NdrEnum):
    MAP = ((64 , 'WBEM_FLAG_CONNECT_REPOSITORY_ONLY'),(256 , 'WBEM_FLAG_CONNECT_PROVIDERS'),)        

class WBEM_GENERIC_FLAG_TYPE(NdrEnum):
    MAP = ((0 , 'WBEM_FLAG_RETURN_WBEM_COMPLETE'),(16 , 'WBEM_FLAG_RETURN_IMMEDIATELY'),(32 , 'WBEM_FLAG_FORWARD_ONLY'),(64 , 'WBEM_FLAG_NO_ERROR_OBJECT'),(128 , 'WBEM_FLAG_SEND_STATUS'),(256 , 'WBEM_FLAG_ENSURE_LOCATABLE'),(512 , 'WBEM_FLAG_DIRECT_READ'),(126976 , 'WBEM_MASK_RESERVED_FLAGS'),(131072 , 'WBEM_FLAG_USE_AMENDED_QUALIFIERS'),(1048576 , 'WBEM_FLAG_STRONG_VALIDATION'),)        

class WBEM_STATUS_TYPE(NdrEnum):
    MAP = ((0 , 'WBEM_STATUS_COMPLETE'),(1 , 'WBEM_STATUS_REQUIREMENTS'),(2 , 'WBEM_STATUS_PROGRESS'),)        

class WBEM_TIMEOUT_TYPE(NdrEnum):
    MAP = ((0 , 'WBEM_NO_WAIT'),(4294967295 , 'WBEM_INFINITE'),)        

class WBEM_BACKUP_RESTORE_FLAGS(NdrEnum):
    MAP = ((1 , 'WBEM_FLAG_BACKUP_RESTORE_FORCE_SHUTDOWN'),)        

class WBEMSTATUS(NdrEnum):
    MAP = ((0 , 'WBEM_S_NO_ERROR'),(1 , 'WBEM_S_FALSE'),(262148 , 'WBEM_S_TIMEDOUT'),(262399 , 'WBEM_S_NEW_STYLE'),(262160 , 'WBEM_S_PARTIAL_RESULTS'),(2147749889 , 'WBEM_E_FAILED'),(2147749890 , 'WBEM_E_NOT_FOUND'),(2147749891 , 'WBEM_E_ACCESS_DENIED'),(2147749892 , 'WBEM_E_PROVIDER_FAILURE'),(2147749893 , 'WBEM_E_TYPE_MISMATCH'),(2147749894 , 'WBEM_E_OUT_OF_MEMORY'),(2147749895 , 'WBEM_E_INVALID_CONTEXT'),(2147749896 , 'WBEM_E_INVALID_PARAMETER'),(2147749897 , 'WBEM_E_NOT_AVAILABLE'),(2147749898 , 'WBEM_E_CRITICAL_ERROR'),(2147749900 , 'WBEM_E_NOT_SUPPORTED'),(2147749905 , 'WBEM_E_PROVIDER_NOT_FOUND'),(2147749906 , 'WBEM_E_INVALID_PROVIDER_REGISTRATION'),(2147749907 , 'WBEM_E_PROVIDER_LOAD_FAILURE'),(2147749908 , 'WBEM_E_INITIALIZATION_FAILURE'),(2147749909 , 'WBEM_E_TRANSPORT_FAILURE'),(2147749910 , 'WBEM_E_INVALID_OPERATION'),(2147749913 , 'WBEM_E_ALREADY_EXISTS'),(2147749917 , 'WBEM_E_UNEXPECTED'),(2147749920 , 'WBEM_E_INCOMPLETE_CLASS'),(2147749939 , 'WBEM_E_SHUTTING_DOWN'),(2147500033 , 'E_NOTIMPL'),(2147749901 , 'WBEM_E_INVALID_SUPERCLASS'),(2147749902 , 'WBEM_E_INVALID_NAMESPACE'),(2147749903 , 'WBEM_E_INVALID_OBJECT'),(2147749904 , 'WBEM_E_INVALID_CLASS'),(2147749911 , 'WBEM_E_INVALID_QUERY'),(2147749912 , 'WBEM_E_INVALID_QUERY_TYPE'),(2147749924 , 'WBEM_E_PROVIDER_NOT_CAPABLE'),(2147749925 , 'WBEM_E_CLASS_HAS_CHILDREN'),(2147749926 , 'WBEM_E_CLASS_HAS_INSTANCES'),(2147749928 , 'WBEM_E_ILLEGAL_NULL'),(2147749933 , 'WBEM_E_INVALID_CIM_TYPE'),(2147749934 , 'WBEM_E_INVALID_METHOD'),(2147749935 , 'WBEM_E_INVALID_METHOD_PARAMETERS'),(2147749937 , 'WBEM_E_INVALID_PROPERTY'),(2147749938 , 'WBEM_E_CALL_CANCELLED'),(2147749946 , 'WBEM_E_INVALID_OBJECT_PATH'),(2147749947 , 'WBEM_E_OUT_OF_DISK_SPACE'),(2147749949 , 'WBEM_E_UNSUPPORTED_PUT_EXTENSION'),(2147749996 , 'WBEM_E_QUOTA_VIOLATION'),(2147749957 , 'WBEM_E_SERVER_TOO_BUSY'),(2147749973 , 'WBEM_E_METHOD_NOT_IMPLEMENTED'),(2147749974 , 'WBEM_E_METHOD_DISABLED'),(2147749976 , 'WBEM_E_UNPARSABLE_QUERY'),(2147749977 , 'WBEM_E_NOT_EVENT_CLASS'),(2147749978 , 'WBEM_E_MISSING_GROUP_WITHIN'),(2147749979 , 'WBEM_E_MISSING_AGGREGATION_LIST'),(2147749980 , 'WBEM_E_PROPERTY_NOT_AN_OBJECT'),(2147749981 , 'WBEM_E_AGGREGATING_BY_OBJECT'),(2147749984 , 'WBEM_E_BACKUP_RESTORE_WINMGMT_RUNNING'),(2147749985 , 'WBEM_E_QUEUE_OVERFLOW'),(2147749986 , 'WBEM_E_PRIVILEGE_NOT_HELD'),(2147749987 , 'WBEM_E_INVALID_OPERATOR'),(2147749989 , 'WBEM_E_CANNOT_BE_ABSTRACT'),(2147749990 , 'WBEM_E_AMENDED_OBJECT'),(2147750010 , 'WBEM_E_VETO_PUT'),(2147750017 , 'WBEM_E_PROVIDER_SUSPENDED'),(2147750023 , 'WBEM_E_ENCRYPTED_CONNECTION_REQUIRED'),(2147750024 , 'WBEM_E_PROVIDER_TIMED_OUT'),(2147750025 , 'WBEM_E_NO_KEY'),(2147750026 , 'WBEM_E_PROVIDER_DISABLED'),(2147753985 , 'WBEM_E_REGISTRATION_TOO_BROAD'),(2147753986 , 'WBEM_E_REGISTRATION_TOO_PRECISE'),)        

class WBEM_REFR_VERSION_NUMBER(NdrEnum):
    MAP = ((2 , 'WBEM_REFRESHER_VERSION'),)        

class WBEM_INSTANCE_BLOB_TYPE(NdrEnum):
    MAP = ((2 , 'WBEM_BLOB_TYPE_ALL'),(3 , 'WBEM_BLOB_TYPE_ERROR'),(4 , 'WBEM_BLOB_TYPE_ENUM'),)        

class WBEM_REFRESHED_OBJECT(NdrStructure):
    MEMBERS = [(LONG, "m_lRequestId"),(WBEM_INSTANCE_BLOB_TYPE, "m_lBlobType"),(LONG, "m_lBlobLength"),(PBYTE, "m_pbBlob"),]

    

class _WBEM_REFRESH_INFO_REMOTE(NdrStructure):
    MEMBERS = [(PIWBEMREMOTEREFRESHER, "m_pRefresher"),(PIWBEMCLASSOBJECT, "m_pTemplate"),(GUID, "m_Guid"),]

    

class _WBEM_REFRESH_INFO_NON_HIPERF(NdrStructure):
    MEMBERS = [(PWCHAR_T, "m_wszNamespace"),(PIWBEMCLASSOBJECT, "m_pTemplate"),]

    

class WBEM_REFRESH_TYPE(NdrEnum):
    MAP = ((0 , 'WBEM_REFRESH_TYPE_INVALID'),(3 , 'WBEM_REFRESH_TYPE_REMOTE'),(6 , 'WBEM_REFRESH_TYPE_NON_HIPERF'),)        

class WBEM_REFRESH_INFO_UNION(NdrUnion):
    SWITCHTYPE = DWORD
    MEMBERS = {1 : (_WBEM_REFRESH_INFO_REMOTE, "m_Remote"),2 : (_WBEM_REFRESH_INFO_NON_HIPERF, "m_NonHiPerf"),3 : (HRESULT, "m_hres"),}

    

class _WBEM_REFRESH_INFO(NdrStructure):
    MEMBERS = [(LONG, "m_lType"),(WBEM_REFRESH_INFO_UNION, "m_Info"),(LONG, "m_lCancelId"),]

    

class _WBEM_REFRESHER_ID(NdrStructure):
    MEMBERS = [(LPSTR, "m_szMachineName"),(DWORD, "m_dwProcessId"),(GUID, "m_guidRefresherId"),]

    

class WBEM_RECONNECT_TYPE(NdrEnum):
    MAP = ((0 , 'WBEM_RECONNECT_TYPE_OBJECT'),(1 , 'WBEM_RECONNECT_TYPE_ENUM'),(2 , 'WBEM_RECONNECT_TYPE_LAST'),)        

class _WBEM_RECONNECT_INFO(NdrStructure):
    MEMBERS = [(LONG, "m_lType"),(LPCWSTR, "m_pwcsPath"),]

    

class _WBEM_RECONNECT_RESULTS(NdrStructure):
    MEMBERS = [(LONG, "m_lId"),(HRESULT, "m_hr"),]

    
Interface("dc12a681-737-11f-884-00a004b2e24", "1.0",[])