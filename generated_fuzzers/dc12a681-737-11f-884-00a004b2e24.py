...
class ('WBEM_REFRESHED_OBJECT', None)(NdrStructure):
    MEMBERS = [(('LONG', None), "m_lRequestId"),(('WBEM_INSTANCE_BLOB_TYPE', None), "m_lBlobType"),(('LONG', None), "m_lBlobLength"),(('PBYTE', None), "m_pbBlob"),]

    

class ('_WBEM_REFRESH_INFO_REMOTE', None)(NdrStructure):
    MEMBERS = [(('PIWBEMREMOTEREFRESHER', None), "m_pRefresher"),(('PIWBEMCLASSOBJECT', None), "m_pTemplate"),(('GUID', None), "m_Guid"),]

    

class ('_WBEM_REFRESH_INFO_NON_HIPERF', None)(NdrStructure):
    MEMBERS = [(('PWCHAR_T', None), "m_wszNamespace"),(('PIWBEMCLASSOBJECT', None), "m_pTemplate"),]

    

class ('WBEM_REFRESH_INFO_UNION', None)(NdrUnion):
    SWITCHTYPE = DWORD
    MEMBERS = {1 : (('_WBEM_REFRESH_INFO_REMOTE', None), m_Remote),2 : (('_WBEM_REFRESH_INFO_NON_HIPERF', None), m_NonHiPerf),3 : (('HRESULT', None), m_hres),}

    

class ('_WBEM_REFRESH_INFO', None)(NdrStructure):
    MEMBERS = [(('LONG', None), "m_lType"),(('WBEM_REFRESH_INFO_UNION', None), "m_Info"),(('LONG', None), "m_lCancelId"),]

    

class ('_WBEM_REFRESHER_ID', None)(NdrStructure):
    MEMBERS = [(('LPSTR', None), "m_szMachineName"),(('DWORD', None), "m_dwProcessId"),(('GUID', None), "m_guidRefresherId"),]

    

class ('_WBEM_RECONNECT_INFO', None)(NdrStructure):
    MEMBERS = [(('LONG', None), "m_lType"),(('LPCWSTR', None), "m_pwcsPath"),]

    

class ('_WBEM_RECONNECT_RESULTS', None)(NdrStructure):
    MEMBERS = [(('LONG', None), "m_lId"),(('HRESULT', None), "m_hr"),]
