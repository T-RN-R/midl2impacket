...
class ('VSS_SNAPSHOT_PROP', None)(NdrStructure):
    MEMBERS = [(('VSS_ID', None), "m_SnapshotId"),(('VSS_ID', None), "m_SnapshotSetId"),(('LONG', None), "m_lSnapshotsCount"),(('VSS_PWSZ', None), "m_pwszSnapshotDeviceObject"),(('VSS_PWSZ', None), "m_pwszOriginalVolumeName"),(('VSS_PWSZ', None), "m_pwszOriginatingMachine"),(('VSS_PWSZ', None), "m_pwszServiceMachine"),(('VSS_PWSZ', None), "m_pwszExposedName"),(('VSS_PWSZ', None), "m_pwszExposedPath"),(('VSS_ID', None), "m_ProviderId"),(('LONG', None), "m_lSnapshotAttributes"),(('VSS_TIMESTAMP', None), "m_tsCreationTimestamp"),(('VSS_SNAPSHOT_STATE', None), "m_eStatus"),]

    

class ('VSS_PROVIDER_PROP', None)(NdrStructure):
    MEMBERS = [(('VSS_ID', None), "m_ProviderId"),(('VSS_PWSZ', None), "m_pwszProviderName"),(('VSS_PROVIDER_TYPE', None), "m_eProviderType"),(('VSS_PWSZ', None), "m_pwszProviderVersion"),(('VSS_ID', None), "m_ProviderVersionId"),(('CLSID', None), "m_ClassId"),]

    

class ('VSS_OBJECT_UNION', None)(NdrUnion):
    SWITCHTYPE = DWORD
    MEMBERS = {1 : (('VSS_SNAPSHOT_PROP', None), Snap),2 : (('VSS_PROVIDER_PROP', None), Prov),}

    

class ('VSS_OBJECT_PROP', None)(NdrStructure):
    MEMBERS = [(('VSS_OBJECT_TYPE', None), "Type"),(('VSS_OBJECT_UNION', None), "Obj"),]

    

class ('VSS_VOLUME_PROP', None)(NdrStructure):
    MEMBERS = [(('VSS_PWSZ', None), "m_pwszVolumeName"),(('VSS_PWSZ', None), "m_pwszVolumeDisplayName"),]

    

class ('VSS_DIFF_VOLUME_PROP', None)(NdrStructure):
    MEMBERS = [(('VSS_PWSZ', None), "m_pwszVolumeName"),(('VSS_PWSZ', None), "m_pwszVolumeDisplayName"),(('LONGLONG', None), "m_llVolumeFreeSpace"),(('LONGLONG', None), "m_llVolumeTotalSpace"),]

    

class ('VSS_DIFF_AREA_PROP', None)(NdrStructure):
    MEMBERS = [(('VSS_PWSZ', None), "m_pwszVolumeName"),(('VSS_PWSZ', None), "m_pwszDiffAreaVolumeName"),(('LONGLONG', None), "m_llMaximumDiffSpace"),(('LONGLONG', None), "m_llAllocatedDiffSpace"),(('LONGLONG', None), "m_llUsedDiffSpace"),]

    

class ('VSS_MGMT_OBJECT_UNION', None)(NdrUnion):
    SWITCHTYPE = DWORD
    MEMBERS = {1 : (('VSS_VOLUME_PROP', None), Vol),2 : (('VSS_DIFF_VOLUME_PROP', None), DiffVol),3 : (('VSS_DIFF_AREA_PROP', None), DiffArea),}

    

class ('VSS_MGMT_OBJECT_PROP', None)(NdrStructure):
    MEMBERS = [(('VSS_MGMT_OBJECT_TYPE', None), "Type"),(('VSS_MGMT_OBJECT_UNION', None), "Obj"),]
