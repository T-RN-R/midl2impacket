...
class VSS_OBJECT_TYPE(NdrEnum):
    MAP = ((0 , 'VSS_OBJECT_UNKNOWN'),(1 , 'VSS_OBJECT_NONE'),(2 , 'VSS_OBJECT_SNAPSHOT_SET'),(3 , 'VSS_OBJECT_SNAPSHOT'),(4 , 'VSS_OBJECT_PROVIDER'),(5 , 'VSS_OBJECT_TYPE_COUNT'),)        

class VSS_SNAPSHOT_STATE(NdrEnum):
    MAP = ((0 , 'VSS_SS_UNKNOWN'),(12 , 'VSS_SS_CREATED'),)        

class VSS_VOLUME_SNAPSHOT_ATTRIBUTES(NdrEnum):
    MAP = ((1 , 'VSS_VOLSNAP_ATTR_PERSISTENT'),(2 , 'VSS_VOLSNAP_ATTR_NO_AUTORECOVERY'),(4 , 'VSS_VOLSNAP_ATTR_CLIENT_ACCESSIBLE'),(8 , 'VSS_VOLSNAP_ATTR_NO_AUTO_RELEASE'),(16 , 'VSS_VOLSNAP_ATTR_NO_WRITERS'),)        

class VSS_MGMT_OBJECT_TYPE(NdrEnum):
    MAP = ((0 , 'VSS_MGMT_OBJECT_UNKNOWN'),(1 , 'VSS_MGMT_OBJECT_VOLUME'),(2 , 'VSS_MGMT_OBJECT_DIFF_VOLUME'),(3 , 'VSS_MGMT_OBJECT_DIFF_AREA'),)        

class VSS_PROVIDER_TYPE(NdrEnum):
    MAP = ((0 , 'VSS_PROV_UNKNOWN'),)        
VSS_ID = GUID
VSS_PWSZ = WCHAR
VSS_TIMESTAMP = LONGLONG

class VSS_SNAPSHOT_PROP(NdrStructure):
    MEMBERS = [(VSS_ID, "m_SnapshotId"),(VSS_ID, "m_SnapshotSetId"),(LONG, "m_lSnapshotsCount"),(VSS_PWSZ, "m_pwszSnapshotDeviceObject"),(VSS_PWSZ, "m_pwszOriginalVolumeName"),(VSS_PWSZ, "m_pwszOriginatingMachine"),(VSS_PWSZ, "m_pwszServiceMachine"),(VSS_PWSZ, "m_pwszExposedName"),(VSS_PWSZ, "m_pwszExposedPath"),(VSS_ID, "m_ProviderId"),(LONG, "m_lSnapshotAttributes"),(VSS_TIMESTAMP, "m_tsCreationTimestamp"),(VSS_SNAPSHOT_STATE, "m_eStatus"),]

    

class VSS_PROVIDER_PROP(NdrStructure):
    MEMBERS = [(VSS_ID, "m_ProviderId"),(VSS_PWSZ, "m_pwszProviderName"),(VSS_PROVIDER_TYPE, "m_eProviderType"),(VSS_PWSZ, "m_pwszProviderVersion"),(VSS_ID, "m_ProviderVersionId"),(CLSID, "m_ClassId"),]

    

class VSS_OBJECT_UNION(NdrUnion):
    SWITCHTYPE = DWORD
    MEMBERS = {1 : (VSS_SNAPSHOT_PROP, "Snap"),2 : (VSS_PROVIDER_PROP, "Prov"),}

    

class VSS_OBJECT_PROP(NdrStructure):
    MEMBERS = [(VSS_OBJECT_TYPE, "Type"),(VSS_OBJECT_UNION, "Obj"),]

    

class VSS_VOLUME_PROP(NdrStructure):
    MEMBERS = [(VSS_PWSZ, "m_pwszVolumeName"),(VSS_PWSZ, "m_pwszVolumeDisplayName"),]

    

class VSS_DIFF_VOLUME_PROP(NdrStructure):
    MEMBERS = [(VSS_PWSZ, "m_pwszVolumeName"),(VSS_PWSZ, "m_pwszVolumeDisplayName"),(LONGLONG, "m_llVolumeFreeSpace"),(LONGLONG, "m_llVolumeTotalSpace"),]

    

class VSS_DIFF_AREA_PROP(NdrStructure):
    MEMBERS = [(VSS_PWSZ, "m_pwszVolumeName"),(VSS_PWSZ, "m_pwszDiffAreaVolumeName"),(LONGLONG, "m_llMaximumDiffSpace"),(LONGLONG, "m_llAllocatedDiffSpace"),(LONGLONG, "m_llUsedDiffSpace"),]

    

class VSS_MGMT_OBJECT_UNION(NdrUnion):
    SWITCHTYPE = DWORD
    MEMBERS = {1 : (VSS_VOLUME_PROP, "Vol"),2 : (VSS_DIFF_VOLUME_PROP, "DiffVol"),3 : (VSS_DIFF_AREA_PROP, "DiffArea"),}

    

class VSS_MGMT_OBJECT_PROP(NdrStructure):
    MEMBERS = [(VSS_MGMT_OBJECT_TYPE, "Type"),(VSS_MGMT_OBJECT_UNION, "Obj"),]

    
Interface("FA7DF749-667-4986-A27F-E2F04AE53772", "1.0",[Method("GetProviderMgmtInterface",
In((VSS_ID,'ProviderId')),
In((REFIID,'InterfaceId')),
Out((PPIUNKNOWN,'ppItf')),
),Method("QueryVolumesSupportedForSnapshots",
In((VSS_ID,'ProviderId')),
In((LONG,'lContext')),
Out((PPIVSSENUMMGMTOBJECT,'ppEnum')),
),Method("QuerySnapshotsByVolume",
In((VSS_PWSZ,'pwszVolumeName')),
In((VSS_ID,'ProviderId')),
Out((PPIVSSENUMOBJECT,'ppEnum')),
),])