...
class VSS_OBJECT_UNION(NdrUnion):
    SWITCHTYPE = DWORD
    MEMBERS = {
        1: (VSS_SNAPSHOT_PROP, "Snap"),
        2: (VSS_PROVIDER_PROP, "Prov"),
    }
...
class VSS_MGMT_OBJECT_UNION(NdrUnion):
    SWITCHTYPE = DWORD
    MEMBERS = {
        1: (VSS_VOLUME_PROP, "Vol"),
        2: (VSS_DIFF_VOLUME_PROP, "DiffVol"),
        3: (VSS_DIFF_AREA_PROP, "DiffArea"),
    }
...
Method("GetProviderMgmtInterface", In(VSS_ID), In(REFIID), Out(PPIUNKNOWN),), Method(
