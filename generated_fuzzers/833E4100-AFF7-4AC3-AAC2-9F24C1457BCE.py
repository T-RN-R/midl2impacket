...
class SESSIONSTATEENUM(NdrEnum):
    MAP = ((0 , 'pchActive'),(1 , 'pchConnected'),(2 , 'pchConnectQuery'),(3 , 'pchShadow'),(4 , 'pchDisconnected'),(5 , 'pchIdle'),(6 , 'pchListen'),(7 , 'pchReset'),(8 , 'pchDown'),(9 , 'pchInit'),(10 , 'pchStateInvalid'),)        
Interface("833E4100-AFF7-4AC3-AAC2-9F24C1457BCE", "1.0",[Method("_NewEnum",
Out((PPIUNKNOWN,'pVal')),
),Method("Item",
In((LONG,'vIndex')),
Out((PVARIANT,'ppEntry')),
),Method("Count",
Out((PLONG,'pVal')),
),])