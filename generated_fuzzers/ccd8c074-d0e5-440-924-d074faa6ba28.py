...
class RESP_ASYNC_NOTIFY(NdrStructure):
    MEMBERS = [(UINT, "MessageType"),(UINT, "Length"),(UINT, "NumberOfMessages"),(PBYTE, "MessageBuffer"),]

    
PRESP_ASYNC_NOTIFY = RESP_ASYNC_NOTIFY
class WITNESS_INTERFACE_INFO(NdrStructure):
    MEMBERS = [(WCHAR, "InterfaceGroupName"),(ULONG, "Version"),(USHORT, "State"),(ULONG, "IPV4"),(USHORT, "IPV6"),(UINT, "Flags"),]

    
PWITNESS_INTERFACE_INFO = WITNESS_INTERFACE_INFO
class WITNESS_INTERFACE_LIST(NdrStructure):
    MEMBERS = [(UINT, "NumberOfInterfaces"),(PWITNESS_INTERFACE_INFO, "InterfaceInfo"),]

    
PWITNESS_INTERFACE_LIST = WITNESS_INTERFACE_LISTMethod("WitnessrGetInterfaceList",
In(HANDLE_T),
