...
class ('RESP_ASYNC_NOTIFY', None)(NdrStructure):
    MEMBERS = [(('UINT', None), "MessageType"),(('UINT', None), "Length"),(('UINT', None), "NumberOfMessages"),(('PBYTE', None), "MessageBuffer"),]

    

class ('WITNESS_INTERFACE_INFO', None)(NdrStructure):
    MEMBERS = [(('WCHAR', None), "InterfaceGroupName"),(('ULONG', None), "Version"),(('USHORT', None), "State"),(('ULONG', None), "IPV4"),(('USHORT', None), "IPV6"),(('UINT', None), "Flags"),]

    

class ('WITNESS_INTERFACE_LIST', None)(NdrStructure):
    MEMBERS = [(('UINT', None), "NumberOfInterfaces"),(('PWITNESS_INTERFACE_INFO', None), "InterfaceInfo"),]
