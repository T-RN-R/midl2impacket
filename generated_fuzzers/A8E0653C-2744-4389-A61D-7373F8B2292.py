...
class FSSAGENT_SHARE_MAPPING_1(NdrStructure):
    MEMBERS = [(GUID, "ShadowCopySetId"),(GUID, "ShadowCopyId"),(LPWSTR, "ShareNameUNC"),(LPWSTR, "ShadowCopyShareName"),(LONGLONG, "CreationTimestamp"),]

    
PFSSAGENT_SHARE_MAPPING_1 = FSSAGENT_SHARE_MAPPING_1

class FSSAGENT_SHARE_MAPPING(NdrUnion):
    SWITCHTYPE = DWORD
    MEMBERS = {1 : (PFSSAGENT_SHARE_MAPPING_1, "ShareMapping1"),}
