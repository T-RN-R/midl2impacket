...
class VDS_VOLUME_NOTIFICATION(NdrStructure):
    MEMBERS = [
        ...
        (UNSIGNED_LONG, "ulPercentCompleted"),
    ]
...
class VDS_STORAGE_IDENTIFIER(NdrStructure):
    MEMBERS = [
        ...
        (UNSIGNED_LONG, "m_cbIdentifier"),
        (PBYTE, "m_rgbIdentifier"),
    ]


class VDS_STORAGE_DEVICE_ID_DESCRIPTOR(NdrStructure):
    MEMBERS = [
        (UNSIGNED_LONG, "m_version"),
        (UNSIGNED_LONG, "m_cIdentifiers"),
        (PVDS_STORAGE_IDENTIFIER, "m_rgIdentifiers"),
    ]
...
class VDS_INTERCONNECT(NdrStructure):
    MEMBERS = [
        ...
        (UNSIGNED_LONG, "m_cbPort"),
        (PBYTE, "m_pbPort"),
        (UNSIGNED_LONG, "m_cbAddress"),
        (PBYTE, "m_pbAddress"),
    ]
...
class VDS_LUN_INFORMATION(NdrStructure):
    MEMBERS = [
        ...
        (PCHAR, "m_szVendorId"),
        (PCHAR, "m_szProductId"),
        (PCHAR, "m_szProductRevision"),
        (PCHAR, "m_szSerialNumber"),
        (GUID, "m_diskSignature"),
        (VDS_STORAGE_DEVICE_ID_DESCRIPTOR, "m_deviceIdDescriptor"),
        (UNSIGNED_LONG, "m_cInterconnects"),
        (PVDS_INTERCONNECT, "m_rgInterconnects"),
    ]
...
class VDS_FILE_SYSTEM_FORMAT_SUPPORT_PROP(NdrStructure):
    MEMBERS = [
        (UNSIGNED_LONG, "ulFlags"),
        (UNSIGNED_SHORT, "usRevision"),
        (UNSIGNED_LONG, "ulDefaultUnitAllocationSize"),
        (UNSIGNED_LONG, "rgulAllowedUnitAllocationSizes"),
        (WCHAR, "wszName"),
    ]
...
class VDS_PARTITION_PROP(NdrStructure):
    MEMBERS = [
        ...
        (UNSIGNED_LONG, "ulFlags"),
        (UNSIGNED_LONG, "ulPartitionNumber"),
        (ULONGLONG, "ullOffset"),
        (ULONGLONG, "ullSize"),
        (U0, "u0"),
    ]
...
class VDS_FILE_SYSTEM_TYPE_PROP(NdrStructure):
    MEMBERS = [
        ...
        (WCHAR, "wszName"),
        (UNSIGNED_LONG, "ulFlags"),
        (UNSIGNED_LONG, "ulCompressionFlags"),
        (UNSIGNED_LONG, "ulMaxLabelLength"),
        (PWCHAR, "pwszIllegalLabelCharSet"),
    ]
...
class VDS_IPADDRESS(NdrStructure):
    MEMBERS = [
        ...
        (UNSIGNED_LONG, "ipv4Address"),
        (UNSIGNED_CHAR, "ipv6Address"),
        (UNSIGNED_LONG, "ulIpv6FlowInfo"),
        (UNSIGNED_LONG, "ulIpv6ScopeId"),
        (WCHAR, "wszTextAddress"),
        (UNSIGNED_LONG, "ulPort"),
    ]


class VDS_ISCSI_SHARED_SECRET(NdrStructure):
    MEMBERS = [
        (PUNSIGNED_CHAR, "pSharedSecret"),
        (UNSIGNED_LONG, "ulSharedSecretSize"),
    ]
...
class VDS_HBAPORT_PROP(NdrStructure):
    MEMBERS = [
        ...
        (UNSIGNED_LONG, "ulPortSpeed"),
        (UNSIGNED_LONG, "ulSupportedPortSpeed"),
    ]
...
class VDS_PROVIDER_PROP(NdrStructure):
    MEMBERS = [
        ...
        (UNSIGNED_LONG, "ulFlags"),
        (UNSIGNED_LONG, "ulStripeSizeFlags"),
...
class VDS_DISK_PROP(NdrStructure):
    MEMBERS = [
        ...
        (DWORD, "dwMediaType"),
        (ULONGLONG, "ullSize"),
        (UNSIGNED_LONG, "ulBytesPerSector"),
        (UNSIGNED_LONG, "ulSectorsPerTrack"),
        (UNSIGNED_LONG, "ulTracksPerCylinder"),
        (UNSIGNED_LONG, "ulFlags"),
        (VDS_STORAGE_BUS_TYPE, "BusType"),
        (VDS_PARTITION_STYLE, "PartitionStyle"),
        (PWSZDEVICEPATH, "u0"),
        (PWCHAR, "pwszDiskAddress"),
        (PWCHAR, "pwszName"),
        (PWCHAR, "pwszFriendlyName"),
        (PWCHAR, "pwszAdaptorName"),
        (PWCHAR, "pwszDevicePath"),
    ]
...
class VDS_VOLUME_PLEX_PROP(NdrStructure):
    MEMBERS = [
        ...
        (VDS_TRANSITION_STATE, "TransitionState"),
        (ULONGLONG, "ullSize"),
        (UNSIGNED_LONG, "ulStripeSize"),
        (UNSIGNED_LONG, "ulNumberOfMembers"),
    ]
...
Method("Next", In(UNSIGNED_LONG), Out(PPIUNKNOWN), Out(PUNSIGNED_LONG),), Method(
    "Skip",
    In(UNSIGNED_LONG),
), Method("Reset",), Method(
    "Clone",
