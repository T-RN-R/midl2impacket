...
class CONTAINERSTATISTICS(NdrStructure):
    MEMBERS = [(DWORD, "cCalls"),(DWORD, "cComponentInstances"),(DWORD, "cComponents"),(DWORD, "cCallsPerSecond"),]

    

class CONTAINERDATA(NdrStructure):
    MEMBERS = [(DWORD, "dwLegacyId"),(WCHAR, "wszApplicationIdentifier"),(DWORD, "dwProcessId"),(CONTAINERSTATISTICS, "statistics"),]

    

class COMPONENTDATA(NdrStructure):
    MEMBERS = [(GUID, "clsid"),(DWORD, "cTotalReferences"),(DWORD, "cBoundReferences"),(DWORD, "cPooledInstances"),(DWORD, "cInstancesInCall"),(DWORD, "dwResponseTime"),(DWORD, "cCallsCompleted"),(DWORD, "cCallsFailed"),]

    
Interface("B60040E0-BCF3-111-861-0080729264", "1.0",[Method("Opnum3NotUsedOnWire",
),Method("GetContainerData",
Out((PDWORD,'nContainers')),
Out((PPCONTAINERDATA,'aContainerData')),
),Method("GetComponentDataByContainer",
In((DWORD,'idContainer')),
Out((PDWORD,'nComponents')),
Out((PPCOMPONENTDATA,'aComponentData')),
),Method("GetComponentDataByContainerAndCLSID",
In((DWORD,'idContainer')),
In((GUID,'clsid')),
Out((PPCOMPONENTDATA,'ppComponentData')),
