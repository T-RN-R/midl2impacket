...
class ('CONTAINERSTATISTICS', None)(NdrStructure):
    MEMBERS = [(('DWORD', None), "cCalls"),(('DWORD', None), "cComponentInstances"),(('DWORD', None), "cComponents"),(('DWORD', None), "cCallsPerSecond"),]

    

class ('CONTAINERDATA', None)(NdrStructure):
    MEMBERS = [(('DWORD', None), "dwLegacyId"),(('WCHAR', None), "wszApplicationIdentifier"),(('DWORD', None), "dwProcessId"),(('CONTAINERSTATISTICS', None), "statistics"),]

    

class ('COMPONENTDATA', None)(NdrStructure):
    MEMBERS = [(('GUID', None), "clsid"),(('DWORD', None), "cTotalReferences"),(('DWORD', None), "cBoundReferences"),(('DWORD', None), "cPooledInstances"),(('DWORD', None), "cInstancesInCall"),(('DWORD', None), "dwResponseTime"),(('DWORD', None), "cCallsCompleted"),(('DWORD', None), "cCallsFailed"),]
