...
class MGMTOBJECTTYPE(NdrEnum):
    MAP = ((1 , 'MGMT_MACHINE'),(2 , 'MGMT_QUEUE'),(3 , 'MGMT_SESSION'),)        

class MGMT_OBJECT(NdrStructure):
    MEMBERS = [(MGMTOBJECTTYPE, "type"),(U0, "u0"),]

    
Interface("41208ee0-e970-11d1-9b9e-00e02c064c39", "1.0",[Method("R_QMMgmtGetInfo",
In((HANDLE_T,'hBind')),
In((PMGMT_OBJECT,'pObjectFormat')),
In((DWORD,'cp')),
In((ULONG,'aProp')),
