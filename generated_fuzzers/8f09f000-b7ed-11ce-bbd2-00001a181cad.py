...
class _PROJECTION_INFO_IDL_1(NdrStructure):
    MEMBERS = []

    
PPROJECTION_INFO_IDL_1 = _PROJECTION_INFO_IDL_1
...
class _RAS_CONNECTION_EX_IDL(NdrStructure):
    MEMBERS = []

    
PRAS_CONNECTION_EX_IDL = _RAS_CONNECTION_EX_IDL
...
class _MPR_SERVER_EX_IDL(NdrStructure):
    MEMBERS = []

    
PMPR_SERVER_EX_IDL = _MPR_SERVER_EX_IDL
...
class _MPR_SERVER_SET_CONFIG_EX_IDL(NdrStructure):
    MEMBERS = []

    
PMPR_SERVER_SET_CONFIG_EX_IDL = _MPR_SERVER_SET_CONFIG_EX_IDL
...
class _RAS_UPDATE_CONNECTION_1_IDL(NdrStructure):
    MEMBERS = []

    
PRAS_UPDATE_CONNECTION_1_IDL = _RAS_UPDATE_CONNECTION_1_IDL
...
class _RAS_UPDATE_CONNECTION_IDL(NdrStructure):
    MEMBERS = []

    
PRAS_UPDATE_CONNECTION_IDL = _RAS_UPDATE_CONNECTION_IDL
...
class RASRPC_CALLBACKLIST(NdrStructure):
    MEMBERS = [(WCHAR, "pszPortName"),(WCHAR, "pszDeviceName"),(WCHAR, "pszNumber"),(DWORD, "dwDeviceType"),(P_RASRPC_CALLBACKLIST, "pNext"),]

    
LPRASRPC_CALLBACKLIST = RASRPC_CALLBACKLIST

class RASRPC_STRINGLIST(NdrStructure):
    MEMBERS = [(WCHAR, "psz"),(P_RASRPC_STRINGLIST, "pNext"),]

    
LPRASRPC_STRINGLIST = RASRPC_STRINGLIST

class RASRPC_LOCATIONLIST(NdrStructure):
    MEMBERS = [(DWORD, "dwLocationId"),(DWORD, "iPrefix"),(DWORD, "iSuffix"),(P_RASRPC_LOCATIONLIST, "pNext"),]
