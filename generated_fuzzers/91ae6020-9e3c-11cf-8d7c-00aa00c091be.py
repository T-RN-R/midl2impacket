...
In((WCHAR_T,'pwszAuthority')),
),])Interface("91ae6020-9e3c-11cf-8d7c-00aa00c091be", "1.0",[Method("CertServerRequest",
In((HANDLE_T,'h')),
In((DWORD,'dwFlags')),
In((PWCHAR_T,'pwszAuthority')),
InOut((PDWORD,'pdwRequestId')),
Out((PDWORD,'pdwDisposition')),
In((PCERTTRANSBLOB,'pctbAttribs')),
In((PCERTTRANSBLOB,'pctbRequest')),
Out((PCERTTRANSBLOB,'pctbCert')),
Out((PCERTTRANSBLOB,'pctbEncodedCert')),
Out((PCERTTRANSBLOB,'pctbDispositionMessage')),
),])