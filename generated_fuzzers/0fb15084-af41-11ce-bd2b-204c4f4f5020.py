...
class ('BOID', None)(NdrStructure):
    MEMBERS = [(('UNSIGNED_CHAR', None), "rgb"),]

    

class ('XACTTRANSINFO', None)(NdrStructure):
    MEMBERS = [(('BOID', None), "uow"),(('LONG', None), "isoLevel"),(('ULONG', None), "isoFlags"),(('DWORD', None), "grfTCSupported"),(('DWORD', None), "grfRMSupported"),(('DWORD', None), "grfTCSupportedRetaining"),(('DWORD', None), "grfRMSupportedRetaining"),]
