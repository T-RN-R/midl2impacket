...
class RPC_VERSION(NdrStructure):
    MEMBERS = [(UNSIGNED_SHORT, "MajorVersion"),(UNSIGNED_SHORT, "MinorVersion"),]

    

class RPC_SYNTAX_IDENTIFIER(NdrStructure):
    MEMBERS = [(GUID, "SyntaxGUID"),(RPC_VERSION, "SyntaxVersion"),]
...
class NSI_BINDING_T(NdrStructure):
    MEMBERS = [(NSI_STRING_BINDING_T, "string"),(UNSIGNED_LONG, "entry_name_syntax"),(STRING_T, "entry_name"),]

    

class NSI_BINDING_VECTOR_T(NdrStructure):
    MEMBERS = [(UNSIGNED_LONG, "count"),(NSI_BINDING_T, "binding"),]

    
NSI_BINDING_VECTOR_P_T = NSI_BINDING_VECTOR_T

class NSI_UUID_VECTOR_T(NdrStructure):
    MEMBERS = [(UNSIGNED_LONG, "count"),(NSI_UUID_P_T, "uuid"),]
