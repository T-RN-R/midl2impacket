...
Interface("1A927394-352E-4553-AE3F-7CF4AAFCA620", "1.0",[Method("WdsRpcMessage",
In((UNSIGNED_LONG,'uRequestPacketSize')),
In((BYTE,'bRequestPacket')),
Out((PUNSIGNED_LONG,'puReplyPacketSize')),
Out((PPBYTE,'pbReplyPacket')),
),])