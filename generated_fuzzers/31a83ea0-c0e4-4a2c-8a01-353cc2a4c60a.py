...
),])Interface("31a83ea0-c0e4-4a2c-8a01-353cc2a4c60a", "1.0",[Method("GetSiteNameFromSiteId",
In((DWORD,'dwSiteId')),
Out((PBSTR,'pbstrSiteName')),
),Method("GetSiteIdFromSiteName",
In((BSTR,'bstrSiteName')),
Out((PDWORD,'pdwSiteId')),
),Method("GetSiteElementFromSiteId",
In((DWORD,'dwSiteId')),
Out((PPIAPPHOSTELEMENT,'ppSiteElement')),
),Method("MapPath",
In((BSTR,'bstrSiteName')),
In((BSTR,'bstrVirtualPath')),
Out((PBSTR,'pbstrPhysicalPath')),
Out((PPIAPPHOSTELEMENT,'ppVirtualDirectoryElement')),
Out((PPIAPPHOSTELEMENT,'ppApplicationElement')),
),])