...
class CPREP_SCSI_ADDRESS(NdrStructure):
    MEMBERS = [
        ...
        (UNSIGNED_CHAR, "PortNumber"),
        (UNSIGNED_CHAR, "PathId"),
        (UNSIGNED_CHAR, "TargetId"),
        (UNSIGNED_CHAR, "Lun"),
    ]
...
class NODE_ROUTE_INFO(NdrStructure):
    MEMBERS = [
        ...
        (SAFEARRAY, "localUnicastIPs"),
        (SAFEARRAY, "remoteUnicastIPs"),
        (SAFEARRAY, "indices"),
    ]
