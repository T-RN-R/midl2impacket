...
class ('CPREP_DISKID', None)(NdrStructure):
    MEMBERS = [(('CPREP_DISKID_ENUM', None), "DiskIdType"),(('U0', None), "u0"),]

    

class ('CPREP_SCSI_ADDRESS', None)(NdrStructure):
    MEMBERS = [(('UNSIGNED_LONG', None), "Length"),(('UNSIGNED_CHAR', None), "PortNumber"),(('UNSIGNED_CHAR', None), "PathId"),(('UNSIGNED_CHAR', None), "TargetId"),(('UNSIGNED_CHAR', None), "Lun"),]

    

class ('DISK_PROPS', None)(NdrStructure):
    MEMBERS = [(('UNSIGNED_LONG', None), "DiskNumber"),(('CPREP_DISKID', None), "DiskId"),(('UNSIGNED_LONG', None), "DiskBusType"),(('DISKSTACKTYPE', None), "StackType"),(('CPREP_SCSI_ADDRESS', None), "ScsiAddress"),(('LONG', None), "DiskIsClusterable"),(('WCHAR_T', None), "AdapterDesc"),(('UNSIGNED_LONG', None), "NumPaths"),(('UNSIGNED_LONG', None), "Flags"),]

    

class ('DISK_PROPS_EX', None)(NdrStructure):
    MEMBERS = [(('ULONG', None), "DiskNumber"),(('CPREP_DISKID', None), "DiskId"),(('ULONG', None), "DiskBusType"),(('DISKSTACKTYPE', None), "StackType"),(('CPREP_SCSI_ADDRESS', None), "ScsiAddress"),(('BOOL', None), "DiskIsClusterable"),(('WCHAR_T', None), "AdapterDesc"),(('LPWSTR', None), "pwszFriendlyName"),(('UNSIGNED_LONG', None), "NumPaths"),(('UNSIGNED_LONG', None), "Flags"),(('UNSIGNED_LONG', None), "ExtendedFlags"),(('LPWSTR', None), "pwszPoolName"),(('LPWSTR', None), "pwszPage83Id"),(('LPWSTR', None), "pwszSerialNumber"),(('GUID', None), "guidPoolId"),]

    

class ('NODE_ROUTE_INFO', None)(NdrStructure):
    MEMBERS = [(('BSTR', None), "remoteVirtualIP"),(('SAFEARRAY', None), "localUnicastIPs"),(('SAFEARRAY', None), "remoteUnicastIPs"),(('SAFEARRAY', None), "indices"),]

    

class ('ADD_ROUTES_REQUEST', None)(NdrStructure):
    MEMBERS = [(('BSTR', None), "localVirtualIP"),(('SAFEARRAY', None), "nodeRouteInfos"),]

    

class ('ROUTE_LOSS_AND_STATE', None)(NdrStructure):
    MEMBERS = [(('ULONG', None), "packetLoss"),(('ROUTE_STATUS', None), "status"),]

    

class ('ADD_ROUTES_REPLY', None)(NdrStructure):
    MEMBERS = [(('SAFEARRAY', None), "indices"),(('SAFEARRAY', None), "replies"),(('BOOLEAN', None), "routeUnavailable"),]

    

class ('CLUSTER_CERT', None)(NdrStructure):
    MEMBERS = [(('ULONG', None), "CbCertData"),(('ULONG', None), "CbKeyData"),(('BYTE', None), "CertData"),(('BYTE', None), "KeyData"),(('WCHAR', None), "ClusterSecret"),]
