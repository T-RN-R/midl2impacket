...
class CATRANSPROP(NdrStructure):
    MEMBERS = [(LONG, "lPropID"),(BYTE, "propType"),(BYTE, "Reserved"),(USHORT, "propFlags"),(ULONG, "obwszDisplayName"),]

    

class CERTTRANSDBATTRIBUTE(NdrStructure):
    MEMBERS = [(ULONG, "obwszName"),(ULONG, "obwszValue"),]

    

class CERTTRANSDBEXTENSION(NdrStructure):
    MEMBERS = [(ULONG, "obwszName"),(LONG, "ExtFlags"),(DWORD, "cbValue"),(ULONG, "obValue"),]

    

class CERTTRANSDBCOLUMN(NdrStructure):
    MEMBERS = [(DWORD, "Type"),(DWORD, "Index"),(DWORD, "cbMax"),(ULONG, "obwszName"),(ULONG, "obwszDisplayName"),]

    

class CERTTRANSDBRESULTCOLUMN(NdrStructure):
    MEMBERS = [(DWORD, "Type"),(DWORD, "Index"),(ULONG, "obValue"),(DWORD, "cbValue"),]

    

class CERTTRANSDBRESULTROW(NdrStructure):
    MEMBERS = [(DWORD, "rowid"),(DWORD, "ccol"),(ULONG, "cbrow"),]

    

class CERTVIEWRESTRICTION(NdrStructure):
    MEMBERS = [(DWORD, "ColumnIndex"),(LONG, "SeekOperator"),(LONG, "SortOrder"),(PBYTE, "pbValue"),(DWORD, "cbValue"),]

    
Interface("d99e6e71-fc88-110-b498-000903123", "1.0",[Method("SetExtension",
In((WCHAR_T,'pwszAuthority')),
In((DWORD,'dwRequestId')),
In((WCHAR_T,'pwszExtensionName')),
In((DWORD,'dwType')),
In((DWORD,'dwFlags')),
In((PCERTTRANSBLOB,'pctbValue')),
...
In((WCHAR_T,'pwszAuthority')),
In((WCHAR_T,'pSerialNumber')),
Out((PLONG,'pRevocationReason')),
Out((PLONG,'pDisposition')),
),Method("PublishCRL",
In((WCHAR_T,'pwszAuthority')),
In((FILETIME,'FileTime')),
),Method("GetCRL",
In((WCHAR_T,'pwszAuthority')),
Out((PCERTTRANSBLOB,'pctbCRL')),
),Method("RevokeCertificate",
In((WCHAR_T,'pwszAuthority')),
In((WCHAR_T,'pwszSerialNumber')),
In((DWORD,'Reason')),
In((FILETIME,'FileTime')),
...
In((DWORD,'cColumn')),
Out((PDWORD,'pcColumn')),
Out((PCERTTRANSBLOB,'pctbColumnInfo')),
...
In((WCHAR_T,'pwszLast')),
In((DWORD,'celt')),
Out((PDWORD,'pceltFetched')),
Out((PCERTTRANSBLOB,'pctbOut')),
),Method("OpenView",
In((WCHAR_T,'pwszAuthority')),
In((DWORD,'ccvr')),
In((CERTVIEWRESTRICTION,'acvr')),
In((DWORD,'ccolOut')),
In((DWORD,'acolOut')),
In((DWORD,'ielt')),
In((DWORD,'celt')),
Out((PDWORD,'pceltFetched')),
Out((PCERTTRANSBLOB,'pctbResultRows')),
),Method("EnumView",
In((WCHAR_T,'pwszAuthority')),
In((DWORD,'ielt')),
In((DWORD,'celt')),
...
In((WCHAR_T,'pwszAuthority')),
In((UNSIGNED_LONG,'grbitJet')),
In((UNSIGNED_LONG,'dwBackupFlags')),
In((WCHAR,'pwszBackupAnnotation')),
In((DWORD,'dwClientIdentifier')),
),Method("BackupEnd",
),Method("BackupGetAttachmentInformation",
Out((PPWCHAR,'ppwszzDBFiles')),
Out((PLONG,'pcwcDBFiles')),
),Method("BackupGetBackupLogs",
Out((PPWCHAR,'ppwszzLogFiles')),
Out((PLONG,'pcwcLogFiles')),
),Method("BackupOpenFile",
In((WCHAR_T,'pwszPath')),
Out((PUNSIGNED_HYPER,'pliLength')),
...
In((WCHAR_T,'pwszAuthority')),
In((PCERTTRANSBLOB,'pctbCertificate')),
In((LONG,'dwFlags')),
Out((PLONG,'pdwRequestId')),
),Method("BackupGetDynamicFiles",
Out((PPWCHAR,'ppwszzFiles')),
Out((PLONG,'pcwcFiles')),
),Method("RestoreGetDatabaseLocations",
Out((PPWCHAR,'ppwszzDatabaseLocations')),
Out((PLONG,'pcwcPaths')),
),])