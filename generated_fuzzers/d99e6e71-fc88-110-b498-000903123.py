...
class ('CERTTRANSBLOB', None)(NdrStructure):
    MEMBERS = [(('ULONG', None), "cb"),(('PBYTE', None), "pb"),]

    

class ('CATRANSPROP', None)(NdrStructure):
    MEMBERS = [(('LONG', None), "lPropID"),(('BYTE', None), "propType"),(('BYTE', None), "Reserved"),(('USHORT', None), "propFlags"),(('ULONG', None), "obwszDisplayName"),]

    

class ('CERTTRANSDBATTRIBUTE', None)(NdrStructure):
    MEMBERS = [(('ULONG', None), "obwszName"),(('ULONG', None), "obwszValue"),]

    

class ('CERTTRANSDBEXTENSION', None)(NdrStructure):
    MEMBERS = [(('ULONG', None), "obwszName"),(('LONG', None), "ExtFlags"),(('DWORD', None), "cbValue"),(('ULONG', None), "obValue"),]

    

class ('CERTTRANSDBCOLUMN', None)(NdrStructure):
    MEMBERS = [(('DWORD', None), "Type"),(('DWORD', None), "Index"),(('DWORD', None), "cbMax"),(('ULONG', None), "obwszName"),(('ULONG', None), "obwszDisplayName"),]

    

class ('CERTTRANSDBRESULTCOLUMN', None)(NdrStructure):
    MEMBERS = [(('DWORD', None), "Type"),(('DWORD', None), "Index"),(('ULONG', None), "obValue"),(('DWORD', None), "cbValue"),]

    

class ('CERTTRANSDBRESULTROW', None)(NdrStructure):
    MEMBERS = [(('DWORD', None), "rowid"),(('DWORD', None), "ccol"),(('ULONG', None), "cbrow"),]

    

class ('CERTVIEWRESTRICTION', None)(NdrStructure):
    MEMBERS = [(('DWORD', None), "ColumnIndex"),(('LONG', None), "SeekOperator"),(('LONG', None), "SortOrder"),(('PBYTE', None), "pbValue"),(('DWORD', None), "cbValue"),]
