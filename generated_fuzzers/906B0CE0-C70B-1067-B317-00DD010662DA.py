...
class BOUND_VERSION_SET(NdrStructure):
    MEMBERS = [(DWORD, "dwLevelOneAccepted"),(DWORD, "dwLevelTwoAccepted"),(DWORD, "dwLevelThreeAccepted"),]

    
COM_PROTOCOL = UNSIGNED_LONG

class BIND_INFO_BLOB(NdrStructure):
