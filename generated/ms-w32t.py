...
class W32TIME_NTPCLIENT_PROVIDER_CONFIG_DATA(NDRSTRUCT):
	...
	structure = (
			...
			(
			'ulCrossSiteSyncFlags',
			UNSIGNED __INT32
			),
			(
			'ulResolvePeerBackoffMinutes',
			UNSIGNED __INT32
			),
			(
			'ulResolvePeerBackoffMaxTimes',
			UNSIGNED __INT32
			),
			(
			'ulCompatibilityFlags',
			UNSIGNED __INT32
			),
			(
			'ulEventLogFlags',
			...
			(
			'ulAllowNonstandardModeCombinationsFlag',
			UNSIGNED __INT32
			),
			(
			'ulCrossSiteSyncFlagsFlag',
			UNSIGNED __INT32
			),
			(
			'ulResolvePeerBackoffMinutesFlag',
			UNSIGNED __INT32
			),
			(
			'ulResolvePeerBackoffMaxTimesFlag',
			UNSIGNED __INT32
			),
			(
			'ulCompatibilityFlagsFlag',
			UNSIGNED __INT32
			),
			(
			'ulEventLogFlagsFlag',
			...
			(
			'ulLargeSampleSkewFlag',
			UNSIGNED __INT32
			),
			(
			'ulSpecialPollIntervalFlag',
			UNSIGNED __INT32
			),
			(
			'ulTypeFlag',
...
class W32TIME_CONFIGURATION_BASIC(NDRSTRUCT):
	...
	structure = (
			...
			(
			'ulMaxNegPhaseCorrection',
			UNSIGNED __INT32
			),
			(
			'ulMaxPosPhaseCorrection',
			UNSIGNED __INT32
			),
			(
			'ulMaxAllowedPhaseOffset',
			UNSIGNED __INT32
			),
			(
			'ulEventLogFlagsFlag',
			...
			(
			'ulTimeJumpAuditOffsetFlag',
			UNSIGNED __INT32
			),
			(
			'ulMinPollIntervalFlag',
			UNSIGNED __INT32
			),
			(
			'ulMaxPollIntervalFlag',
			UNSIGNED __INT32
			),
			(
			'ulMaxNegPhaseCorrectionFlag',
			UNSIGNED __INT32
			),
			(
			'ulMaxPosPhaseCorrectionFlag',
			UNSIGNED __INT32
			),
			(
			'ulMaxAllowedPhaseOffsetFlag',
			UNSIGNED __INT32
			)
		)
...
class W32TIME_CONFIGURATION_ADVANCED(NDRSTRUCT):
	...
	structure = (
			...
			(
			'ulFrequencyCorrectRateFlag',
			UNSIGNED __INT32
			),
			(
			'ulPollAdjustFactorFlag',
			UNSIGNED __INT32
			),
			(
			'ulLargePhaseOffsetFlag',
			UNSIGNED __INT32
			),
			(
			'ulSpikeWatchPeriodFlag',
			UNSIGNED __INT32
			),
			(
			'ulLocalClockDispersionFlag',
			UNSIGNED __INT32
			),
			(
			'ulHoldPeriodFlag',
			...
			(
			'ulPhaseCorrectRateFlag',
			UNSIGNED __INT32
			),
			(
			'ulUpdateIntervalFlag',
			UNSIGNED __INT32
			)
		)
...
class DATA_W32TIME_CONFIGURATION_INFO(NDRUniConformantArray):
	item = PW32TIME_ENTRY


class PTR_W32TIME_CONFIGURATION_INFO(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_W32TIME_CONFIGURATION_INFO
			)
		)


class W32TIME_CONFIGURATION_INFO(NDRSTRUCT):
	align = 1
	structure = (
			(
			'ulSize',
			...
			(
			'pEntries',
			PTR_W32TIME_CONFIGURATION_INFO
			)
		)
...
OPNUMS = {0 : (
	...
	W32TimeGetNetlogonServiceBitsResponse
	),2 : (
	W32TimeQueryProviderStatus,
	W32TimeQueryProviderStatusResponse
	),3 : (
	W32TimeQuerySource,
	W32TimeQuerySourceResponse
	),4 : (
	W32TimeQueryProviderConfiguration,
	W32TimeQueryProviderConfigurationResponse
	),5 : (
	W32TimeQueryConfiguration,
	W32TimeQueryConfigurationResponse
	),6 : (
	W32TimeQueryStatus,
	W32TimeQueryStatusResponse
	),7 : (
	W32TimeLog,
	W32TimeLogResponse
	)}
