...
class PTR_W32TIME_CONFIGURATION_INFO(NDRPOINTER):
    referent = (
        ('Data', DATA_W32TIME_CONFIGURATION_INFO),
    )

class W32TIME_CONFIGURATION_INFO(NDRSTRUCT):
    structure = (
	('ulSize', UNSIGNED __INT32),	('basicConfig', W32TIME_CONFIGURATION_BASIC),	('advancedConfig', W32TIME_CONFIGURATION_ADVANCED),	('defaultConfig', W32TIME_CONFIGURATION_DEFAULT),	('cProviderConfig', UNSIGNED __INT32),	('pProviderConfig', PW32TIME_CONFIGURATION_PROVIDER),	('cEntries', UNSIGNED __INT32),	('pEntries', PTR_W32TIME_CONFIGURATION_INFO),
