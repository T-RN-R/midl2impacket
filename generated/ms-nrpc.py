...
class PTR_NETLOGON_DELTA_GROUP_MEMBER(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_NETLOGON_DELTA_GROUP_MEMBER
			)
		)
...
class NETLOGON_DELTA_GROUP_MEMBER(NDRSTRUCT):
	...
	structure = (
			...
			(
			'Attributes',
			PTR_NETLOGON_DELTA_GROUP_MEMBER
			),
			(
			'MemberCount',
			ULONG
...
class PTR_NETLOGON_DELTA_TRUSTED_DOMAINS(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_NETLOGON_DELTA_TRUSTED_DOMAINS
			)
		)
...
class NETLOGON_DELTA_TRUSTED_DOMAINS(NDRSTRUCT):
	...
	structure = (
			...
			(
			'SecurityDescriptor',
			PTR_NETLOGON_DELTA_TRUSTED_DOMAINS
			),
			(
			'DummyString1',
			RPC_UNICODE_STRING
...
NETLOGON_DELTA_TYPE = DWORD__ENUM
AddOrChangeDomain = 1
AddOrChangeGroup = 2
DeleteGroup = 3
RenameGroup = 4
...
NETLOGON_LOGON_INFO_CLASS = DWORD__ENUM
...
class NETLOGON_GENERIC_INFO(NDRSTRUCT):
	...
	structure = (
			...
			(
			'LogonData',
			PTR_NETLOGON_GENERIC_INFO
			)
		)


class NETLOGON_LEVEL(NDRUNION):
	union = {NetlogonInteractiveInformation : (
		'LogonInteractive',
...
NETLOGON_VALIDATION_INFO_CLASS = DWORD__ENUM
...
class PTR_NETLOGON_VALIDATION_GENERIC_INFO2(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_NETLOGON_VALIDATION_GENERIC_INFO2
			)
		)
...
class NETLOGON_VALIDATION_GENERIC_INFO2(NDRSTRUCT):
	...
	structure = (
			...
			(
			'ValidationData',
			PTR_NETLOGON_VALIDATION_GENERIC_INFO2
			)
		)
...
class NETLOGON_VALIDATION(NDRUNION):
	union = {NetlogonValidationSamInfo : (
		'ValidationSam',
...
class NL_GENERIC_RPC_DATA(NDRSTRUCT):
	...
	structure = (
			...
			(
			'UnicodeStringEntryCount',
			ULONG
			),
			(
			'UnicodeStringData',
			PTR_NL_GENERIC_RPC_DATA
			)
		)
...
NETLOGON_SECURE_CHANNEL_TYPE = DWORD__ENUM
NullSecureChannel = 0
...
OPNUMS = {0 : (
	NetrLogonUasLogon,
	NetrLogonUasLogonResponse
	),1 : (
	NetrLogonUasLogoff,
	NetrLogonUasLogoffResponse
	),2 : (
	NetrLogonSamLogon,
	NetrLogonSamLogonResponse
	),3 : (
	NetrLogonSamLogoff,
	NetrLogonSamLogoffResponse
	),4 : (
	NetrServerReqChallenge,
	NetrServerReqChallengeResponse
	),5 : (
	NetrServerAuthenticate,
	NetrServerAuthenticateResponse
	),6 : (
	NetrServerPasswordSet,
	NetrServerPasswordSetResponse
	),7 : (
	NetrDatabaseDeltas,
	NetrDatabaseDeltasResponse
	),8 : (
	NetrDatabaseSync,
	NetrDatabaseSyncResponse
	),9 : (
	NetrAccountDeltas,
	NetrAccountDeltasResponse
	),10 : (
	NetrAccountSync,
	NetrAccountSyncResponse
	),11 : (
	NetrGetDCName,
	NetrGetDCNameResponse
	),12 : (
	NetrLogonControl,
	NetrLogonControlResponse
	),13 : (
	NetrGetAnyDCName,
	NetrGetAnyDCNameResponse
	),14 : (
	NetrLogonControl2,
	NetrLogonControl2Response
	),15 : (
	NetrServerAuthenticate2,
	NetrServerAuthenticate2Response
	),16 : (
	NetrDatabaseSync2,
	NetrDatabaseSync2Response
	),17 : (
	NetrDatabaseRedo,
	NetrDatabaseRedoResponse
	),18 : (
	NetrLogonControl2Ex,
	NetrLogonControl2ExResponse
	),19 : (
	NetrEnumerateTrustedDomains,
	NetrEnumerateTrustedDomainsResponse
	),20 : (
	DsrGetDcName,
	DsrGetDcNameResponse
	),21 : (
	NetrLogonGetCapabilities,
	NetrLogonGetCapabilitiesResponse
	),22 : (
	NetrLogonSetServiceBits,
	NetrLogonSetServiceBitsResponse
	),23 : (
	NetrLogonGetTrustRid,
	NetrLogonGetTrustRidResponse
	),24 : (
	NetrLogonComputeServerDigest,
	NetrLogonComputeServerDigestResponse
	),25 : (
	NetrLogonComputeClientDigest,
	NetrLogonComputeClientDigestResponse
	),26 : (
	NetrServerAuthenticate3,
	NetrServerAuthenticate3Response
	),27 : (
	DsrGetDcNameEx,
	DsrGetDcNameExResponse
	),28 : (
	DsrGetSiteName,
	DsrGetSiteNameResponse
	),29 : (
	NetrLogonGetDomainInfo,
	NetrLogonGetDomainInfoResponse
	),30 : (
	NetrServerPasswordSet2,
	NetrServerPasswordSet2Response
	),31 : (
	NetrServerPasswordGet,
	NetrServerPasswordGetResponse
	),32 : (
	NetrLogonSendToSam,
	NetrLogonSendToSamResponse
	),33 : (
	...
	NetrEnumerateTrustedDomainsExResponse
	),37 : (
	DsrAddressToSiteNamesExW,
	DsrAddressToSiteNamesExWResponse
	),38 : (
	DsrGetDcSiteCoverageW,
	DsrGetDcSiteCoverageWResponse
	),39 : (
	NetrLogonSamLogonEx,
	NetrLogonSamLogonExResponse
	),40 : (
	DsrEnumerateDomainTrusts,
	DsrEnumerateDomainTrustsResponse
	),41 : (
	DsrDeregisterDnsHostRecords,
	DsrDeregisterDnsHostRecordsResponse
	),42 : (
	NetrServerTrustPasswordsGet,
	NetrServerTrustPasswordsGetResponse
	),43 : (
	DsrGetForestTrustInformation,
	DsrGetForestTrustInformationResponse
	),44 : (
	...
	NetrServerGetTrustInfoResponse
	),47 : (
	OpnumUnused47,
	OpnumUnused47Response
	),48 : (
	DsrUpdateReadOnlyServerDnsRecords,
	DsrUpdateReadOnlyServerDnsRecordsResponse
	),49 : (
	NetrChainSetClientAttributes,
	NetrChainSetClientAttributesResponse
	)}
