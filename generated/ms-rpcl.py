...
#LocToLoc Definition
#################################################################################
MSRPC_UUID_LOCTOLOC = uuidtup_to_bin(('e33c0cc4-0482-101-bc0c-026086a218','0.0'))
...
OPNUMS = {0 : (
	I_nsi_lookup_begin,
	I_nsi_lookup_beginResponse
	),1 : (
	I_nsi_lookup_done,
	I_nsi_lookup_doneResponse
	),2 : (
	I_nsi_lookup_next,
	I_nsi_lookup_nextResponse
	),3 : (
	I_nsi_entry_object_inq_next,
	I_nsi_entry_object_inq_nextResponse
	),4 : (
	I_nsi_ping_locator,
	I_nsi_ping_locatorResponse
	),5 : (
	I_nsi_entry_object_inq_done,
	I_nsi_entry_object_inq_doneResponse
	),6 : (
	I_nsi_entry_object_inq_begin,
	I_nsi_entry_object_inq_beginResponse
	)}
