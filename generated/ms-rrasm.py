...
class BOOL(NDRSTRUCT):
    structure = (
	('dwSize', DWORD),	('IsEKUOID', BOOL),	('pwszEKU', PTR_BOOL),
...
class DWORD(NDRSTRUCT):
    structure = (
	('dwIdleTimeout', DWORD),	('dwNetworkBlackoutTime', DWORD),	('dwSaLifeTime', DWORD),	('dwSaDataSizeForRenegotiation', DWORD),	('dwConfigOptions', DWORD),	('dwTotalCertificates', DWORD),	('certificateNames', PTR_DWORD),
...
class DATA_ROUTER_CUSTOM_IKEV2_POLICY_0(NDRUniConformantArray):
    item = CERT_BLOB_1

class PTR_ROUTER_CUSTOM_IKEV2_POLICY_0(NDRPOINTER):
    referent = (
        ('Data', DATA_ROUTER_CUSTOM_IKEV2_POLICY_0),
    )
