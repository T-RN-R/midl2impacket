...
OPNUMS = {0 : (
	...
	Opnum7NotUsedByProtocolResponse
	),1 : (
	Opnum8NotUsedByProtocol,
	Opnum8NotUsedByProtocolResponse
	),2 : (
	Opnum9NotUsedByProtocol,
	Opnum9NotUsedByProtocolResponse
	),3 : (
	Opnum10NotUsedByProtocol,
	Opnum10NotUsedByProtocolResponse
	),4 : (
	Opnum11NotUsedByProtocol,
	Opnum11NotUsedByProtocolResponse
	),5 : (
	Opnum12NotUsedByProtocol,
	Opnum12NotUsedByProtocolResponse
	),6 : (
	Opnum13NotUsedByProtocol,
	Opnum13NotUsedByProtocolResponse
	),7 : (
	Opnum14NotUsedByProtocol,
	Opnum14NotUsedByProtocolResponse
	),8 : (
	Opnum15NotUsedByProtocol,
	Opnum15NotUsedByProtocolResponse
	),9 : (
	Opnum16NotUsedByProtocol,
	Opnum16NotUsedByProtocolResponse
	),10 : (
	Opnum17NotUsedByProtocol,
	Opnum17NotUsedByProtocolResponse
	),11 : (
	Opnum18NotUsedByProtocol,
	Opnum18NotUsedByProtocolResponse
	),12 : (
	RemoteConnectionParms,
	RemoteConnectionParmsResponse
	),13 : (
	RemoteUserSessionInfo,
	RemoteUserSessionInfoResponse
	),14 : (
	Opnum21NotUsedByProtocol,
	Opnum21NotUsedByProtocolResponse
	)}
#################################################################################
