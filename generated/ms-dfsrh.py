...
#TYPEDEFS
#################################################################################
DfsrHelperErrorsEnum = DWORD__ENUM
...
DfsrReportingFlags = DWORD__ENUM
...
OPNUMS = {0 : (
	...
	GetCompressedReport,
	GetCompressedReportResponse
	),2 : (
	GetRawReportEx,
	GetRawReportExResponse
	),3 : (
	GetReferenceVersionVectors,
	GetReferenceVersionVectorsResponse
	),4 : (
	Opnum7NotUsedOnWire,
	Opnum7NotUsedOnWireResponse
	),5 : (
	GetReferenceBacklogCounts,
	GetReferenceBacklogCountsResponse
	)}
#################################################################################
