...
class PTR_REMOTEREADDESC(NDRPOINTER):
    referent = (
        ('Data', DATA_REMOTEREADDESC),
    )

class REMOTEREADDESC(NDRSTRUCT):
    structure = (
	('hRemoteQueue', DWORD),	('hCursor', DWORD),	('ulAction', DWORD),	('ulTimeout', DWORD),	('dwSize', DWORD),	('dwQueue', DWORD),	('dwRequestID', DWORD),	('Reserved', DWORD),	('dwArriveTime', DWORD),	('eAckNack', REMOTEREADACK),	('lpBuffer', PTR_REMOTEREADDESC),
