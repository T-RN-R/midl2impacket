...
#TYPEDEFS
#################################################################################
CPREP_DISKID_ENUM = DWORD__ENUM
CprepIdSignature = 0
CprepIdGuid = 1
CprepIdNumber = 4000
CprepIdUnknown = 5000
class U0(NDRUNION):
	union = {CprepIdSignature : (
		'DiskSignature',
		UNSIGNED_LONG
		),CprepIdGuid : (
		'DiskGuid',
...
CLUSTER_NETWORK_PROFILE = DWORD__ENUM
...
OPNUMS = {0 : (
	CprepDiskRawRead,
	CprepDiskRawReadResponse
	),1 : (
	CprepDiskRawWrite,
	CprepDiskRawWriteResponse
	),2 : (
	CprepPrepareNode,
	CprepPrepareNodeResponse
	),3 : (
	CprepPrepareNodePhase2,
	CprepPrepareNodePhase2Response
	),4 : (
	CprepDiskGetProps,
	CprepDiskGetPropsResponse
	),5 : (
	Opnum8NotUsedOnWire,
	...
	CprepDiskStopDefenseResponse
	),10 : (
	CprepDiskOnline,
	CprepDiskOnlineResponse
	),11 : (
	CprepDiskVerifyUnique,
	CprepDiskVerifyUniqueResponse
	),12 : (
	Opnum15NotUsedOnWire,
	Opnum15NotUsedOnWireResponse
	),13 : (
	...
	CprepDiskWriteFileDataResponse
	),15 : (
	CprepDiskVerifyFileData,
	CprepDiskVerifyFileDataResponse
	),16 : (
	CprepDiskDeleteFile,
	CprepDiskDeleteFileResponse
	),17 : (
	CprepDiskOffline,
	CprepDiskOfflineResponse
	),18 : (
	Opnum21NotUsedOnWire,
	Opnum21NotUsedOnWireResponse
	),19 : (
	CprepDiskGetUniqueIds,
	CprepDiskGetUniqueIdsResponse
	),20 : (
	CprepDiskAttach,
	CprepDiskAttachResponse
	),21 : (
	CprepDiskPRArbitrate,
	CprepDiskPRArbitrateResponse
	),22 : (
	CprepDiskPRRegister,
	CprepDiskPRRegisterResponse
	),23 : (
	CprepDiskPRUnRegister,
	CprepDiskPRUnRegisterResponse
	),24 : (
	CprepDiskPRReserve,
	CprepDiskPRReserveResponse
	),25 : (
	CprepDiskPRRelease,
	CprepDiskPRReleaseResponse
	),26 : (
	CprepDiskDiskPartitionIsNtfs,
	CprepDiskDiskPartitionIsNtfsResponse
	),27 : (
	CprepDiskGetArbSectors,
	CprepDiskGetArbSectorsResponse
	),28 : (
	CprepDiskIsPRPresent,
	CprepDiskIsPRPresentResponse
	),29 : (
	CprepDiskPRPreempt,
	CprepDiskPRPreemptResponse
	),30 : (
	CprepDiskPRClear,
	CprepDiskPRClearResponse
	),31 : (
	CprepDiskIsOnline,
	CprepDiskIsOnlineResponse
	),32 : (
	CprepDiskSetOnline,
	CprepDiskSetOnlineResponse
	),33 : (
	CprepDiskGetFSName,
	CprepDiskGetFSNameResponse
	),34 : (
	CprepDiskIsReadable,
	CprepDiskIsReadableResponse
	),35 : (
	CprepDiskGetDsms,
	CprepDiskGetDsmsResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	CprepDiskGetUniqueIds3Response
	),1 : (
	CprepCheckNetFtBindings3,
	CprepCheckNetFtBindings3Response
	),2 : (
	CprepCsvTestSetup3,
	CprepCsvTestSetup3Response
	),3 : (
	CprepIsNodeClustered3,
	CprepIsNodeClustered3Response
	),4 : (
	CprepCreateNewSmbShares3,
	CprepCreateNewSmbShares3Response
	),5 : (
	CprepConnectToNewSmbShares3,
	CprepConnectToNewSmbShares3Response
	),6 : (
	CprepDiskGetProps3,
	CprepDiskGetProps3Response
	),7 : (
	CprepDiskIsReadOnly3,
	CprepDiskIsReadOnly3Response
	),8 : (
	CprepDiskPRRegister3,
	CprepDiskPRRegister3Response
	),9 : (
	CprepDiskFindKey3,
	CprepDiskFindKey3Response
	),10 : (
	CprepDiskPRPreempt3,
	CprepDiskPRPreempt3Response
	),11 : (
	CprepDiskPRReserve3,
	CprepDiskPRReserve3Response
	),12 : (
	CprepDiskIsPRPresent3,
	CprepDiskIsPRPresent3Response
	),13 : (
	CprepDiskPRRelease3,
	CprepDiskPRRelease3Response
	),14 : (
	CprepDiskPRClear3,
	CprepDiskPRClear3Response
	)}
#################################################################################
...
OPNUMS = {0 : (
	SendRTMessage,
	SendRTMessageResponse
	),1 : (
	InitializeNode,
	InitializeNodeResponse
	),2 : (
	GetIpConfigSerialized,
	GetIpConfigSerializedResponse
	),3 : (
	CleanupNode,
	CleanupNodeResponse
	),4 : (
	QueryFirewallConfiguration,
	QueryFirewallConfigurationResponse
	),5 : (
	ProcessAddRoutes,
	ProcessAddRoutesResponse
	),6 : (
	GetAddRoutesStatus,
	GetAddRoutesStatusResponse
	),7 : (
	Opnum10Reserved,
	Opnum10ReservedResponse
	),8 : (
	CancelAddRoutesRequest,
	CancelAddRoutesRequestResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	ConfigSvcSecret,
	ConfigSvcSecretResponse
	),1 : (
	RetrieveSvcSecret,
	RetrieveSvcSecretResponse
	),2 : (
	RetrieveHostLabel,
	RetrieveHostLabelResponse
	),3 : (
	GetFunctionalLevel,
	GetFunctionalLevelResponse
	),4 : (
	Opnum7Reserved,
	Opnum7ReservedResponse
	),5 : (
	Opnum8Reserved,
	Opnum8ReservedResponse
	),6 : (
	ConfigClusterCert,
	ConfigClusterCertResponse
	),7 : (
	RetrieveClusterCert,
	RetrieveClusterCertResponse
	),8 : (
	GenerateClusterCert,
	GenerateClusterCertResponse
	),9 : (
	GetUpgradeVersion,
	GetUpgradeVersionResponse
	),10 : (
	Opnum13Reserved,
	Opnum13ReservedResponse
	),11 : (
	ConfigClusterCerV2,
	ConfigClusterCerV2Response
	),12 : (
	RetrieveClusterCertV2,
	RetrieveClusterCertV2Response
	),13 : (
	GenerateClusterCertV2,
	GenerateClusterCertV2Response
	)}
#################################################################################
...
OPNUMS = {0 : (
	GenerateClusterLog,
	GenerateClusterLogResponse
	),1 : (
	GenerateTimeSpanLog,
	GenerateTimeSpanLogResponse
	),2 : (
	GenerateClusterLogInLocalTime,
	GenerateClusterLogInLocalTimeResponse
	),3 : (
	GenerateTimeSpanLogInLocalTime,
	GenerateTimeSpanLogInLocalTimeResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	GenerateClusterHealthLogResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	InitializeAdapterConfigurationResponse
	),1 : (
	GetNextAdapterFirewallConfiguration,
	GetNextAdapterFirewallConfigurationResponse
	)}
#################################################################################
