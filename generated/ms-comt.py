...
OPNUMS = {0 : (
	...
	GetContainerData,
	GetContainerDataResponse
	),2 : (
	GetComponentDataByContainer,
	GetComponentDataByContainerResponse
	),3 : (
	GetComponentDataByContainerAndCLSID,
	GetComponentDataByContainerAndCLSIDResponse
	),4 : (
	Opnum7NotUsedOnWire,
