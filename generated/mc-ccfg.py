...
#IClusCfgAsyncEvictCleanup Definition

#################################################################################

MSRPC_UUID_ICLUSCFGASYNCEVICTCLEANUP = uuidtup_to_bin(('52C80B95-C1AD-4240-8D89-72E9FA84025E','0.0'))


class CleanupNode(NDRCALL):
    opnum = 0
    structure = (
		('BSTREVICTEDNODENAMEIN', BSTR),
		('NDELAYIN', LONG),
		('NTIMEOUTIN', LONG),
    )
...
OPNUMS = {
0 : (CleanupNode,CleanupNodeResponse),
}
