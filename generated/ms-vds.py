...
class VDS_PACK_NOTIFICATION(NDRSTRUCT):
    structure = (
        ('ulEvent', UNSIGNED_LONG),('packId', VDS_OBJECT_ID),
    )


class VDS_DISK_NOTIFICATION(NDRSTRUCT):
    structure = (
        ('ulEvent', UNSIGNED_LONG),('diskId', VDS_OBJECT_ID),
    )


class VDS_VOLUME_NOTIFICATION(NDRSTRUCT):
    structure = (
        ('ulEvent', UNSIGNED_LONG),('volumeId', VDS_OBJECT_ID),('plexId', VDS_OBJECT_ID),('ulPercentCompleted', UNSIGNED_LONG),
    )


class VDS_PARTITION_NOTIFICATION(NDRSTRUCT):
    structure = (
        ('ulEvent', UNSIGNED_LONG),('diskId', VDS_OBJECT_ID),('ullOffset', ULONGLONG),
    )


class VDS_DRIVE_LETTER_NOTIFICATION(NDRSTRUCT):
    structure = (
        ('ulEvent', UNSIGNED_LONG),('wcLetter', WCHAR),('volumeId', VDS_OBJECT_ID),
    )


class VDS_FILE_SYSTEM_NOTIFICATION(NDRSTRUCT):
    structure = (
        ('ulEvent', UNSIGNED_LONG),('volumeId', VDS_OBJECT_ID),('dwPercentCompleted', DWORD),
    )


class VDS_MOUNT_POINT_NOTIFICATION(NDRSTRUCT):
    structure = (
        ('ulEvent', UNSIGNED_LONG),('volumeId', VDS_OBJECT_ID),
    )
...
class U0(NDRUNION):
    union = {
        VDS_ASYNCOUT_CREATE_VDISK: ('cp',CP),VDS_ASYNCOUT_CREATE_VDISK: ('cv',CV),VDS_ASYNCOUT_CREATE_VDISK: ('bvp',BVP),VDS_ASYNCOUT_CREATE_VDISK: ('sv',SV),VDS_ASYNCOUT_CREATE_VDISK: ('cvd',CVD),
    }
        

class VDS_ASYNC_OUTPUT(NDRSTRUCT):
    structure = (
        ('type', VDS_ASYNC_OUTPUT_TYPE),('u0', U0),
    )


class VDS_PARTITION_INFO_MBR(NDRSTRUCT):
    structure = (
        ('partitionType', BYTE),('bootIndicator', BOOLEAN),('recognizedPartition', BOOLEAN),('hiddenSectors', DWORD),
    )


class VDS_PARTITION_INFO_GPT(NDRSTRUCT):
    structure = (
        ('partitionType', GUID),('partitionId', GUID),('attributes', ULONGLONG),('name', WCHAR),
    )
...
class VDS_FILE_SYSTEM_PROP(NDRSTRUCT):
    structure = (
        ('type', VDS_FILE_SYSTEM_TYPE),('volumeId', VDS_OBJECT_ID),('ulFlags', UNSIGNED_LONG),('ullTotalAllocationUnits', ULONGLONG),('ullAvailableAllocationUnits', ULONGLONG),('ulAllocationUnitSize', UNSIGNED_LONG),('pwszLabel', WCHAR),
    )
...
class VDS_FILE_SYSTEM_FORMAT_SUPPORT_PROP(NDRSTRUCT):
    structure = (
        ('ulFlags', UNSIGNED_LONG),('usRevision', UNSIGNED_SHORT),('ulDefaultUnitAllocationSize', UNSIGNED_LONG),('rgulAllowedUnitAllocationSizes', UNSIGNED_LONG),('wszName', WCHAR),
    )
...
class VDS_DISK_EXTENT(NDRSTRUCT):
    structure = (
        ('diskId', VDS_OBJECT_ID),('type', VDS_DISK_EXTENT_TYPE),('ullOffset', ULONGLONG),('ullSize', ULONGLONG),('volumeId', VDS_OBJECT_ID),('plexId', VDS_OBJECT_ID),('memberIdx', UNSIGNED_LONG),
    )
...
class VDS_DISK_FREE_EXTENT(NDRSTRUCT):
    structure = (
        ('diskId', VDS_OBJECT_ID),('ullOffset', ULONGLONG),('ullSize', ULONGLONG),
    )
...
class U0(NDRUNION):
    union = {
        VDS_PST_MBR: ('Mbr',VDS_PARTITION_INFO_MBR),VDS_PST_GPT: ('Gpt',VDS_PARTITION_INFO_GPT),
    }
        

class VDS_PARTITION_PROP(NDRSTRUCT):
    structure = (
        ('PartitionStyle', VDS_PARTITION_STYLE),('ulFlags', UNSIGNED_LONG),('ulPartitionNumber', UNSIGNED_LONG),('ullOffset', ULONGLONG),('ullSize', ULONGLONG),('u0', U0),
    )


class VDS_INPUT_DISK(NDRSTRUCT):
    structure = (
        ('diskId', VDS_OBJECT_ID),('ullSize', ULONGLONG),('plexId', VDS_OBJECT_ID),('memberIdx', UNSIGNED_LONG),
    )


class MBRPARTINFO(NDRSTRUCT):
    structure = (
        ('partitionType', BYTE),('bootIndicator', BOOLEAN),
    )
...
class U0(NDRUNION):
    union = {
        VDS_PST_GPT: ('MbrPartInfo',MBRPARTINFO),VDS_PST_GPT: ('GptPartInfo',GPTPARTINFO),
    }
        

class CREATE_PARTITION_PARAMETERS(NDRSTRUCT):
    structure = (
        ('style', VDS_PARTITION_STYLE),('u0', U0),
    )


class VIRTUAL_STORAGE_TYPE(NDRSTRUCT):
    structure = (
        ('DeviceId', ULONG),('VendorId', GUID),
    )
...
class VDS_REPARSE_POINT_PROP(NDRSTRUCT):
    structure = (
        ('SourceVolumeId', VDS_OBJECT_ID),('pwszPath', WCHAR),
    )
...
class VDS_DRIVE_LETTER_PROP(NDRSTRUCT):
    structure = (
        ('wcLetter', WCHAR),('volumeId', VDS_OBJECT_ID),('ulFlags', UNSIGNED_LONG),('bUsed', LONG),
    )
...
class VDS_FILE_SYSTEM_TYPE_PROP(NDRSTRUCT):
    structure = (
        ('type', VDS_FILE_SYSTEM_TYPE),('wszName', WCHAR),('ulFlags', UNSIGNED_LONG),('ulCompressionFlags', UNSIGNED_LONG),('ulMaxLabelLength', UNSIGNED_LONG),('pwszIllegalLabelCharSet', WCHAR),
    )
...
class VDS_IPADDRESS(NDRSTRUCT):
    structure = (
        ('type', VDS_IPADDRESS_TYPE),('ipv4Address', UNSIGNED_LONG),('ipv6Address', UNSIGNED_CHAR),('ulIpv6FlowInfo', UNSIGNED_LONG),('ulIpv6ScopeId', UNSIGNED_LONG),('wszTextAddress', WCHAR),('ulPort', UNSIGNED_LONG),
    )
...
class VDS_SERVICE_PROP(NDRSTRUCT):
    structure = (
        ('pwszVersion', WCHAR),('ulFlags', UNSIGNED_LONG),
    )


class VDS_HBAPORT_PROP(NDRSTRUCT):
    structure = (
        ('id', VDS_OBJECT_ID),('wwnNode', VDS_WWN),('wwnPort', VDS_WWN),('type', VDS_HBAPORT_TYPE),('status', VDS_HBAPORT_STATUS),('ulPortSpeed', UNSIGNED_LONG),('ulSupportedPortSpeed', UNSIGNED_LONG),
    )


class VDS_ISCSI_INITIATOR_ADAPTER_PROP(NDRSTRUCT):
    structure = (
        ('id', VDS_OBJECT_ID),('pwszName', WCHAR),
    )


class VDS_ISCSI_INITIATOR_PORTAL_PROP(NDRSTRUCT):
    structure = (
        ('id', VDS_OBJECT_ID),('address', VDS_IPADDRESS),('ulPortIndex', UNSIGNED_LONG),
    )


class VDS_PROVIDER_PROP(NDRSTRUCT):
    structure = (
        ('id', VDS_OBJECT_ID),('pwszName', WCHAR),('guidVersionId', GUID),('pwszVersion', WCHAR),('type', VDS_PROVIDER_TYPE),('ulFlags', UNSIGNED_LONG),('ulStripeSizeFlags', UNSIGNED_LONG),('sRebuildPriority', SHORT),
    )


class VDS_PACK_PROP(NDRSTRUCT):
    structure = (
        ('id', VDS_OBJECT_ID),('pwszName', WCHAR),('status', VDS_PACK_STATUS),('ulFlags', UNSIGNED_LONG),
    )
...
class U0(NDRUNION):
    union = {
        VDS_PST_MBR: ('dwSignature',DWORD),VDS_PST_GPT: ('DiskGuid',GUID),
    }
        

class VDS_DISK_PROP(NDRSTRUCT):
    structure = (
        ('id', VDS_OBJECT_ID),('status', VDS_DISK_STATUS),('ReserveMode', VDS_LUN_RESERVE_MODE),('health', VDS_HEALTH),('dwDeviceType', DWORD),('dwMediaType', DWORD),('ullSize', ULONGLONG),('ulBytesPerSector', UNSIGNED_LONG),('ulSectorsPerTrack', UNSIGNED_LONG),('ulTracksPerCylinder', UNSIGNED_LONG),('ulFlags', UNSIGNED_LONG),('BusType', VDS_STORAGE_BUS_TYPE),('PartitionStyle', VDS_PARTITION_STYLE),('u0', U0),('pwszDiskAddress', WCHAR),('pwszName', WCHAR),('pwszFriendlyName', WCHAR),('pwszAdaptorName', WCHAR),('pwszDevicePath', WCHAR),
    )
...
class VDS_DISK_PROP2(NDRSTRUCT):
    structure = (
        ('id', VDS_OBJECT_ID),('status', VDS_DISK_STATUS),('ReserveMode', VDS_LUN_RESERVE_MODE),('health', VDS_HEALTH),('dwDeviceType', DWORD),('dwMediaType', DWORD),('ullSize', ULONGLONG),('ulBytesPerSector', UNSIGNED_LONG),('ulSectorsPerTrack', UNSIGNED_LONG),('ulTracksPerCylinder', UNSIGNED_LONG),('ulFlags', UNSIGNED_LONG),('BusType', VDS_STORAGE_BUS_TYPE),('PartitionStyle', VDS_PARTITION_STYLE),('u0', U0),('pwszDiskAddress', WCHAR),('pwszName', WCHAR),('pwszFriendlyName', WCHAR),('pwszAdaptorName', WCHAR),('pwszDevicePath', WCHAR),('pwszLocationPath', WCHAR),
    )
...
class VDS_ADVANCEDDISK_PROP(NDRSTRUCT):
    structure = (
        ('pwszId', LPWSTR),('pwszPathname', LPWSTR),('pwszLocation', LPWSTR),('pwszFriendlyName', LPWSTR),('pswzIdentifier', LPWSTR),('usIdentifierFormat', USHORT),('ulNumber', ULONG),('pwszSerialNumber', LPWSTR),('pwszFirmwareVersion', LPWSTR),('pwszManufacturer', LPWSTR),('pwszModel', LPWSTR),('ullTotalSize', ULONGLONG),('ullAllocatedSize', ULONGLONG),('ulLogicalSectorSize', ULONG),('ulPhysicalSectorSize', ULONG),('ulPartitionCount', ULONG),('status', VDS_DISK_STATUS),('health', VDS_HEALTH),('BusType', VDS_STORAGE_BUS_TYPE),('PartitionStyle', VDS_PARTITION_STYLE),('u0', U0),('ulFlags', ULONG),('dwDeviceType', DWORD),
    )
...
class VDS_VOLUME_PROP(NDRSTRUCT):
    structure = (
        ('id', VDS_OBJECT_ID),('type', VDS_VOLUME_TYPE),('status', VDS_VOLUME_STATUS),('health', VDS_HEALTH),('TransitionState', VDS_TRANSITION_STATE),('ullSize', ULONGLONG),('ulFlags', UNSIGNED_LONG),('RecommendedFileSystemType', VDS_FILE_SYSTEM_TYPE),('pwszName', WCHAR),
    )
...
class VDS_VOLUME_PLEX_PROP(NDRSTRUCT):
    structure = (
        ('id', VDS_OBJECT_ID),('type', VDS_VOLUME_PLEX_TYPE),('status', VDS_VOLUME_PLEX_STATUS),('health', VDS_HEALTH),('TransitionState', VDS_TRANSITION_STATE),('ullSize', ULONGLONG),('ulStripeSize', UNSIGNED_LONG),('ulNumberOfMembers', UNSIGNED_LONG),
    )
...
class VDS_CREATE_VDISK_PARAMETERS(NDRSTRUCT):
    structure = (
        ('UniqueId', GUID),('MaximumSize', ULONGLONG),('BlockSizeInBytes', ULONG),('SectorSizeInBytes', ULONG),('pParentPath', LPWSTR),('pSourcePath', LPWSTR),
    )
...
class VDS_VDISK_PROPERTIES(NDRSTRUCT):
    structure = (
        ('Id', VDS_OBJECT_ID),('State', VDS_VDISK_STATE),('VirtualDeviceType', VIRTUAL_STORAGE_TYPE),('VirtualSize', ULONGLONG),('PhysicalSize', ULONGLONG),('pPath', LPWSTR),('pDeviceName', LPWSTR),('DiskFlag', DEPENDENT_DISK_FLAG),('bIsChild', BOOL),('pParentPath', LPWSTR),
    )
...
class QueryStatusResponse(NDRCALL):
    structure = (
		('pHrResult', HRESULT),
		('pulPercentCompleted', UNSIGNED_LONG),
    )
        
OPNUMS = {
0 : (Cancel,CancelResponse),
1 : (Wait,WaitResponse),
2 : (QueryStatus,QueryStatusResponse),
}
...
OPNUMS = {
0 : (LoadService,LoadServiceResponse),
}
...
OPNUMS = {
0 : (IsServiceReady,IsServiceReadyResponse),
1 : (WaitForServiceReady,WaitForServiceReadyResponse),
2 : (GetProperties,GetPropertiesResponse),
3 : (QueryProviders,QueryProvidersResponse),
4 : (Opnum07NotUsedOnWire,Opnum07NotUsedOnWireResponse),
5 : (QueryUnallocatedDisks,QueryUnallocatedDisksResponse),
6 : (GetObject,GetObjectResponse),
7 : (QueryDriveLetters,QueryDriveLettersResponse),
8 : (QueryFileSystemTypes,QueryFileSystemTypesResponse),
9 : (Reenumerate,ReenumerateResponse),
10 : (Refresh,RefreshResponse),
11 : (CleanupObsoleteMountPoints,CleanupObsoleteMountPointsResponse),
12 : (Advise,AdviseResponse),
13 : (Unadvise,UnadviseResponse),
14 : (Reboot,RebootResponse),
15 : (SetFlags,SetFlagsResponse),
...
OPNUMS = {
0 : (Initialize,InitializeResponse),
}
...
OPNUMS = {
0 : (GetDiskIdFromLunInfo,GetDiskIdFromLunInfoResponse),
1 : (UninstallDisks,UninstallDisksResponse),
}
...
OPNUMS = {
0 : (QueryHbaPorts,QueryHbaPortsResponse),
}
...
OPNUMS = {
0 : (GetInitiatorName,GetInitiatorNameResponse),
1 : (QueryInitiatorAdapters,QueryInitiatorAdaptersResponse),
2 : (Opnum05NotUsedOnWire,Opnum05NotUsedOnWireResponse),
3 : (Opnum06NotUsedOnWire,Opnum06NotUsedOnWireResponse),
4 : (Opnum07NotUsedOnWire,Opnum07NotUsedOnWireResponse),
5 : (SetInitiatorSharedSecret,SetInitiatorSharedSecretResponse),
6 : (Opnum09NotUsedOnWire,Opnum09NotUsedOnWireResponse),
}
...
OPNUMS = {
0 : (GetSANPolicy,GetSANPolicyResponse),
1 : (SetSANPolicy,SetSANPolicyResponse),
}
...
OPNUMS = {
0 : (GetDiskObject,GetDiskObjectResponse),
}
...
OPNUMS = {
0 : (GetProperties,GetPropertiesResponse),
1 : (SetAllPathStatuses,SetAllPathStatusesResponse),
}
...
OPNUMS = {
0 : (GetProperties,GetPropertiesResponse),
1 : (QueryInitiatorPortals,QueryInitiatorPortalsResponse),
2 : (Opnum05NotUsedOnWire,Opnum05NotUsedOnWireResponse),
3 : (Opnum06NotUsedOnWire,Opnum06NotUsedOnWireResponse),
}
...
OPNUMS = {
0 : (GetProperties,GetPropertiesResponse),
1 : (GetInitiatorAdapter,GetInitiatorAdapterResponse),
2 : (Opnum05NotUsedOnWire,Opnum05NotUsedOnWireResponse),
3 : (Opnum06NotUsedOnWire,Opnum06NotUsedOnWireResponse),
4 : (Opnum07NotUsedOnWire,Opnum07NotUsedOnWireResponse),
}
...
OPNUMS = {
0 : (QueryPacks,QueryPacksResponse),
1 : (CreatePack,CreatePackResponse),
}
...
OPNUMS = {
0 : (QuerySubSystems,QuerySubSystemsResponse),
1 : (Opnum04NotUsedOnWire,Opnum04NotUsedOnWireResponse),
2 : (Opnum05NotUsedOnWire,Opnum05NotUsedOnWireResponse),
}
...
OPNUMS = {
0 : (QueryVDisks,QueryVDisksResponse),
1 : (CreateVDisk,CreateVDiskResponse),
2 : (AddVDisk,AddVDiskResponse),
3 : (GetDiskFromVDisk,GetDiskFromVDiskResponse),
4 : (GetVDiskFromDisk,GetVDiskFromDiskResponse),
}
...
OPNUMS = {
0 : (GetImportTarget,GetImportTargetResponse),
1 : (SetImportTarget,SetImportTargetResponse),
}
...
OPNUMS = {
0 : (GetProperties,GetPropertiesResponse),
1 : (GetProvider,GetProviderResponse),
2 : (QueryVolumes,QueryVolumesResponse),
3 : (QueryDisks,QueryDisksResponse),
4 : (CreateVolume,CreateVolumeResponse),
5 : (AddDisk,AddDiskResponse),
6 : (MigrateDisks,MigrateDisksResponse),
7 : (Opnum10NotUsedOnWire,Opnum10NotUsedOnWireResponse),
8 : (RemoveMissingDisk,RemoveMissingDiskResponse),
9 : (Recover,RecoverResponse),
}
...
OPNUMS = {
0 : (CreateVolume2,CreateVolume2Response),
}
...
OPNUMS = {
0 : (GetProperties,GetPropertiesResponse),
1 : (GetPack,GetPackResponse),
2 : (GetIdentificationData,GetIdentificationDataResponse),
3 : (QueryExtents,QueryExtentsResponse),
4 : (ConvertStyle,ConvertStyleResponse),
5 : (SetFlags,SetFlagsResponse),
6 : (ClearFlags,ClearFlagsResponse),
}
...
OPNUMS = {
0 : (SetSANMode,SetSANModeResponse),
}
...
class QueryFreeExtentsResponse(NDRCALL):
    structure = (
		...
		('plNumberOfFreeExtents', LONG),
    )
        
OPNUMS = {
0 : (GetProperties2,GetProperties2Response),
1 : (QueryFreeExtents,QueryFreeExtentsResponse),
}
...
OPNUMS = {
0 : (GetPartitionProperties,GetPartitionPropertiesResponse),
1 : (QueryPartitions,QueryPartitionsResponse),
2 : (CreatePartition,CreatePartitionResponse),
3 : (DeletePartition,DeletePartitionResponse),
4 : (ChangeAttributes,ChangeAttributesResponse),
5 : (AssignDriveLetter,AssignDriveLetterResponse),
6 : (DeleteDriveLetter,DeleteDriveLetterResponse),
7 : (GetDriveLetter,GetDriveLetterResponse),
8 : (FormatPartition,FormatPartitionResponse),
9 : (Clean,CleanResponse),
}
...
OPNUMS = {
0 : (ChangePartitionType,ChangePartitionTypeResponse),
}
...
OPNUMS = {
0 : (GetProperties,GetPropertiesResponse),
1 : (GetUniqueId,GetUniqueIdResponse),
}
...
OPNUMS = {
0 : (CreatePartitionEx,CreatePartitionExResponse),
}
...
OPNUMS = {
0 : (Online,OnlineResponse),
1 : (Offline,OfflineResponse),
}
...
OPNUMS = {
0 : (GetPartitionFileSystemProperties,GetPartitionFileSystemPropertiesResponse),
1 : (GetPartitionFileSystemTypeName,GetPartitionFileSystemTypeNameResponse),
2 : (QueryPartitionFileSystemFormatSupport,QueryPartitionFileSystemFormatSupportResponse),
3 : (FormatPartitionEx,FormatPartitionExResponse),
}
...
OPNUMS = {
0 : (FormatPartitionEx2,FormatPartitionEx2Response),
}
...
OPNUMS = {
0 : (QueryMedia,QueryMediaResponse),
1 : (Eject,EjectResponse),
}
...
0 : (GetProperties,GetPropertiesResponse),
1 : (GetPack,GetPackResponse),
2 : (QueryPlexes,QueryPlexesResponse),
3 : (Extend,ExtendResponse),
4 : (Shrink,ShrinkResponse),
5 : (AddPlex,AddPlexResponse),
6 : (BreakPlex,BreakPlexResponse),
7 : (RemovePlex,RemovePlexResponse),
8 : (Delete,DeleteResponse),
9 : (SetFlags,SetFlagsResponse),
...
class QueryAccessPathsResponse(NDRCALL):
    structure = (
		('pwszPathArray', LPWSTR),
		('plNumberOfAccessPaths', LONG),
    )
...
class QueryReparsePointsResponse(NDRCALL):
    structure = (
		...
		('plNumberOfReparsePointProps', LONG),
    )
...
OPNUMS = {
0 : (GetFileSystemProperties,GetFileSystemPropertiesResponse),
1 : (Format,FormatResponse),
2 : (AddAccessPath,AddAccessPathResponse),
3 : (QueryAccessPaths,QueryAccessPathsResponse),
4 : (QueryReparsePoints,QueryReparsePointsResponse),
5 : (DeleteAccessPath,DeleteAccessPathResponse),
6 : (Mount,MountResponse),
7 : (Dismount,DismountResponse),
8 : (SetFileSystemFlags,SetFileSystemFlagsResponse),
9 : (ClearFileSystemFlags,ClearFileSystemFlagsResponse),
}
...
OPNUMS = {
0 : (GetFileSystemTypeName,GetFileSystemTypeNameResponse),
1 : (QueryFileSystemFormatSupport,QueryFileSystemFormatSupportResponse),
2 : (FormatEx,FormatExResponse),
}
...
OPNUMS = {
0 : (QueryVolumeGuidPathnames,QueryVolumeGuidPathnamesResponse),
1 : (FormatEx2,FormatEx2Response),
2 : (OfflineVolume,OfflineVolumeResponse),
}
...
class QueryMaxReclaimableBytesResponse(NDRCALL):
    structure = (
		('pullMaxNumberOfReclaimableBytes', ULONGLONG),
    )
...
class Shrink(NDRCALL):
    opnum = 1
    structure = (
		('ullDesiredNumberOfReclaimableBytes', ULONGLONG),
		('ullMinNumberOfReclaimableBytes', ULONGLONG),
    )
...
OPNUMS = {
0 : (QueryMaxReclaimableBytes,QueryMaxReclaimableBytesResponse),
1 : (Shrink,ShrinkResponse),
}
...
OPNUMS = {
0 : (GetProperties,GetPropertiesResponse),
1 : (GetVolume,GetVolumeResponse),
2 : (QueryExtents,QueryExtentsResponse),
3 : (Repair,RepairResponse),
}
...
class GetPropertiesResponse(NDRCALL):
    structure = (
		('pDiskProperties', PVDS_VDISK_PROPERTIES),
    )
...
OPNUMS = {
0 : (Open,OpenResponse),
1 : (GetProperties,GetPropertiesResponse),
2 : (GetHostVolume,GetHostVolumeResponse),
3 : (GetDeviceName,GetDeviceNameResponse),
}
...
OPNUMS = {
0 : (Attach,AttachResponse),
1 : (Detach,DetachResponse),
2 : (DetachAndDelete,DetachAndDeleteResponse),
3 : (Compact,CompactResponse),
4 : (Merge,MergeResponse),
5 : (Expand,ExpandResponse),
}
