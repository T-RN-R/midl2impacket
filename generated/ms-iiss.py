...
#IIisServiceControl Definition

#################################################################################

MSRPC_UUID_IIISSERVICECONTROL = uuidtup_to_bin(('E8FB8620-588-112-961-0004795E','0.0'))
...
OPNUMS = {
0 : (Stop,StopResponse),
1 : (Start,StartResponse),
2 : (Reboot,RebootResponse),
3 : (Status,StatusResponse),
4 : (Kill,KillResponse),
}
