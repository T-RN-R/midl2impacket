...
#lsacap Definition
#################################################################################
MSRPC_UUID_LSACAP = uuidtup_to_bin(('afc07e2e-311-4435-808-c483ffeec7c9','0.0'))
...
OPNUMS = {0 : (
	...
	LsarGetAvailableCAPIDsResponse
	)}
