...
CatSrvServices = DWORD__ENUM
css_lb = 1
CatSrvServiceState = DWORD__ENUM
...
class Initialize64BitQueryCellSupport(NDRCALL):
	...
	structure = (
			(
			'bClientSupports64BitQueryCells',
			BOOL
			)
		)
...
OPNUMS = {0 : (
	...
	SupportsMultipleBitnessResponse
	),1 : (
...
OPNUMS = {0 : (
	...
	CreateFullConfigurationResponse
	),1 : (
	CreateLegacyConfiguration,
	CreateLegacyConfigurationResponse
	),2 : (
	PromoteLegacyConfiguration,
	PromoteLegacyConfigurationResponse
	),3 : (
	Opnum6NotUsedOnWire,
	Opnum6NotUsedOnWireResponse
	),4 : (
...
class ImportFromFile(NDRCALL):
	...
	structure = (
			(
			'pwszModuleDestination',
			WCHAR
			),
			(
			'pwszInstallerPackage',
			WCHAR
			),
			(
			'pwszUser',
...
OPNUMS = {0 : (
	...
	WaitForEndWrites,
	WaitForEndWritesResponse
	),2 : (
	GetEventClassesForIID,
	GetEventClassesForIIDResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	CopyConglomerations,
	CopyConglomerationsResponse
	),1 : (
	CopyComponentConfiguration,
	CopyComponentConfigurationResponse
	),2 : (
	AliasComponent,
	AliasComponentResponse
	),3 : (
	MoveComponentConfiguration,
	MoveComponentConfigurationResponse
	),4 : (
	GetEventClassesForIID2,
	GetEventClassesForIID2Response
	),5 : (
	IsSafeToDelete,
	IsSafeToDeleteResponse
	),6 : (
	FlushPartitionCache,
	FlushPartitionCacheResponse
	),7 : (
	EnumerateSRPLevels,
	EnumerateSRPLevelsResponse
	),8 : (
...
OPNUMS = {0 : (
	...
	ShutdownContainers,
	ShutdownContainersResponse
	),2 : (
	RefreshComponents,
	RefreshComponentsResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	IsContainerPaused,
	IsContainerPausedResponse
	),4 : (
	GetRunningContainers,
	GetRunningContainersResponse
	),5 : (
	GetContainerIDFromProcessID,
	GetContainerIDFromProcessIDResponse
	),6 : (
	RecycleContainer,
	RecycleContainerResponse
	),7 : (
	GetContainerIDFromConglomerationID,
	GetContainerIDFromConglomerationIDResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	CreateEmptyDir,
	CreateEmptyDirResponse
	),2 : (
	RemoveShare,
	RemoveShareResponse
	),3 : (
	BeginReplicationAsTarget,
	BeginReplicationAsTargetResponse
	),4 : (
	QueryConglomerationPassword,
	QueryConglomerationPasswordResponse
	),5 : (
	CreateReplicationDir,
	CreateReplicationDirResponse
	)}
