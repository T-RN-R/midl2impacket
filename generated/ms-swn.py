...
OPNUMS = {0 : (
	...
	WitnessrGetInterfaceListResponse
	),1 : (
	WitnessrRegister,
	WitnessrRegisterResponse
	),2 : (
	WitnessrUnRegister,
	WitnessrUnRegisterResponse
	),3 : (
	WitnessrAsyncNotify,
	WitnessrAsyncNotifyResponse
	),4 : (
	WitnessrRegisterEx,
	WitnessrRegisterExResponse
	)}
