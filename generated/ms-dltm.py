...
class PTR_TRKSVR_CALL_MOVE_NOTIFICATION(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_TRKSVR_CALL_MOVE_NOTIFICATION
			)
		)
...
class TRKSVR_CALL_MOVE_NOTIFICATION(NDRSTRUCT):
	...
	structure = (
			...
			(
			'rgdroidNew',
			PTR_TRKSVR_CALL_MOVE_NOTIFICATION
			)
		)
...
class TRKSVR_CALL_DELETE(NDRSTRUCT):
	...
	structure = (
			...
			(
			'pVolumes',
			PTR_TRKSVR_CALL_DELETE
			)
		)


TRKSVR_SYNC_TYPE = DWORD__ENUM
CREATE_VOLUME = 0
QUERY_VOLUME = 1
CLAIM_VOLUME = 2
FIND_VOLUME = 3
...
class TRKSVR_STATISTICS(NDRSTRUCT):
	...
	structure = (
			...
			(
			'dwCachedVolumeTableCount',
			UNSIGNED_LONG
			),
			(
			'dwCachedMoveTableCount',
			UNSIGNED_LONG
			),
			(
			'ftCachedLastUpdated',
			...
			(
			'cAvailableRPCThreads',
			UNSIGNED_LONG
			),
			(
			'cLowestAvailableRPCThreads',
			UNSIGNED_LONG
			),
			(
			'cNumThreadPoolThreads',
			UNSIGNED_LONG
			),
			(
			'cMostThreadPoolThreads',
			UNSIGNED_LONG
			),
			(
			'cEntriesToGC',
...
TRKSVR_MESSAGE_TYPE = DWORD__ENUM
old_SEARCH = 0
MOVE_NOTIFICATION = 1
REFRESH = 2
SYNC_VOLUMES = 3
...
SEARCH = 6
WKS_CONFIG = 7
TRKSVR_MESSAGE_PRIORITY = DWORD__ENUM
PRI_0 = 0
PRI_1 = 1
PRI_2 = 2
PRI_3 = 3
...
OPNUMS = {0 : (
	LnkSvrMessage,
	LnkSvrMessageResponse
	),1 : (
	LnkSvrMessageCallback,
	LnkSvrMessageCallbackResponse
	)}
