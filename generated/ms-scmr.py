...
class DATA_SERVICE_FAILURE_ACTIONSA(NDRUniConformantArray):
	item = SC_ACTION


class PTR_SERVICE_FAILURE_ACTIONSA(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_SERVICE_FAILURE_ACTIONSA
			)
		)


class SERVICE_FAILURE_ACTIONSA(NDRSTRUCT):
	align = 1
	structure = (
			(
			'dwResetPeriod',
...
class DATA_SERVICE_FAILURE_ACTIONSW(NDRUniConformantArray):
	item = SC_ACTION


class PTR_SERVICE_FAILURE_ACTIONSW(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_SERVICE_FAILURE_ACTIONSW
			)
		)
...
class SERVICE_FAILURE_ACTIONSW(NDRSTRUCT):
	...
	structure = (
			...
			(
			'lpsaActions',
			PTR_SERVICE_FAILURE_ACTIONSW
			)
		)


SC_STATUS_TYPE = DWORD__ENUM
SC_STATUS_PROCESS_INFO = 0
SC_ENUM_TYPE = DWORD__ENUM
...
OPNUMS = {0 : (
	...
	RQueryServiceObjectSecurityResponse
	),5 : (
	RSetServiceObjectSecurity,
	RSetServiceObjectSecurityResponse
	),6 : (
	RQueryServiceStatus,
	RQueryServiceStatusResponse
	),7 : (
	RSetServiceStatus,
	RSetServiceStatusResponse
	),8 : (
	RUnlockServiceDatabase,
	RUnlockServiceDatabaseResponse
	),9 : (
	RNotifyBootConfigStatus,
	RNotifyBootConfigStatusResponse
	),10 : (
	...
	REnumDependentServicesWResponse
	),14 : (
	REnumServicesStatusW,
	REnumServicesStatusWResponse
	),15 : (
	ROpenSCManagerW,
	...
	RQueryServiceLockStatusWResponse
	),19 : (
	RStartServiceW,
	RStartServiceWResponse
	),20 : (
	RGetServiceDisplayNameW,
	RGetServiceDisplayNameWResponse
	),21 : (
	RGetServiceKeyNameW,
	RGetServiceKeyNameWResponse
	),22 : (
	Opnum22NotUsedOnWire,
	Opnum22NotUsedOnWireResponse
	),23 : (
	RChangeServiceConfigA,
	RChangeServiceConfigAResponse
	),24 : (
	RCreateServiceA,
	RCreateServiceAResponse
	),25 : (
	REnumDependentServicesA,
	REnumDependentServicesAResponse
	),26 : (
	REnumServicesStatusA,
	REnumServicesStatusAResponse
	),27 : (
	ROpenSCManagerA,
	ROpenSCManagerAResponse
	),28 : (
	ROpenServiceA,
	ROpenServiceAResponse
	),29 : (
	RQueryServiceConfigA,
	RQueryServiceConfigAResponse
	),30 : (
	RQueryServiceLockStatusA,
	RQueryServiceLockStatusAResponse
	),31 : (
	RStartServiceA,
	RStartServiceAResponse
	),32 : (
	RGetServiceDisplayNameA,
	RGetServiceDisplayNameAResponse
	),33 : (
	RGetServiceKeyNameA,
	RGetServiceKeyNameAResponse
	),34 : (
	Opnum34NotUsedOnWire,
	Opnum34NotUsedOnWireResponse
	),35 : (
	REnumServiceGroupW,
	REnumServiceGroupWResponse
	),36 : (
	RChangeServiceConfig2A,
	RChangeServiceConfig2AResponse
	),37 : (
	RChangeServiceConfig2W,
	RChangeServiceConfig2WResponse
	),38 : (
	RQueryServiceConfig2A,
	RQueryServiceConfig2AResponse
	),39 : (
	RQueryServiceConfig2W,
	RQueryServiceConfig2WResponse
	),40 : (
	RQueryServiceStatusEx,
	RQueryServiceStatusExResponse
	),41 : (
	REnumServicesStatusExA,
	REnumServicesStatusExAResponse
	),42 : (
	...
	RCreateServiceWOW64AResponse
	),45 : (
	RCreateServiceWOW64W,
	RCreateServiceWOW64WResponse
	),46 : (
	Opnum46NotUsedOnWire,
	Opnum46NotUsedOnWireResponse
	),47 : (
	RNotifyServiceStatusChange,
	RNotifyServiceStatusChangeResponse
	),48 : (
	RGetNotifyResults,
	RGetNotifyResultsResponse
	),49 : (
	RCloseNotifyHandle,
	RCloseNotifyHandleResponse
	),50 : (
	RControlServiceExA,
	RControlServiceExAResponse
	),51 : (
	RControlServiceExW,
	RControlServiceExWResponse
	),52 : (
	Opnum52NotUsedOnWire,
	Opnum52NotUsedOnWireResponse
	),53 : (
	Opnum53NotUsedOnWire,
	Opnum53NotUsedOnWireResponse
	),54 : (
