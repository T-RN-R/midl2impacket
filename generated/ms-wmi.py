...
WBEM_STATUS_TYPE = DWORD__ENUM
WBEM_STATUS_COMPLETE = 0
WBEM_STATUS_REQUIREMENTS = 1
WBEM_STATUS_PROGRESS = 2
WBEM_TIMEOUT_TYPE = DWORD__ENUM
WBEM_NO_WAIT = 0
WBEM_INFINITE = 4294967295
WBEM_BACKUP_RESTORE_FLAGS = DWORD__ENUM
WBEM_FLAG_BACKUP_RESTORE_FORCE_SHUTDOWN = 1
WBEMSTATUS = DWORD__ENUM
WBEM_S_NO_ERROR = 0
WBEM_S_FALSE = 1
...
WBEM_REFR_VERSION_NUMBER = DWORD__ENUM
WBEM_REFRESHER_VERSION = 2
WBEM_INSTANCE_BLOB_TYPE = DWORD__ENUM
...
class WBEM_REFRESH_INFO_UNION(NDRUNION):
	union = {WBEM_REFRESH_TYPE_REMOTE : (
		'm_Remote',
...
WBEM_RECONNECT_TYPE = DWORD__ENUM
...
OPNUMS = {0 : (
	GetResultObject,
	GetResultObjectResponse
	),1 : (
	GetResultString,
	GetResultStringResponse
	),2 : (
	GetResultServices,
	GetResultServicesResponse
	),3 : (
	GetCallStatus,
...
OPNUMS = {0 : (
	...
	CancelAsyncCall,
	CancelAsyncCallResponse
	),2 : (
	QueryObjectSink,
	QueryObjectSinkResponse
	),3 : (
	GetObject,
	GetObjectResponse
	),4 : (
	GetObjectAsync,
	GetObjectAsyncResponse
	),5 : (
	PutClass,
	PutClassResponse
	),6 : (
	PutClassAsync,
	PutClassAsyncResponse
	),7 : (
	DeleteClass,
	DeleteClassResponse
	),8 : (
	DeleteClassAsync,
	DeleteClassAsyncResponse
	),9 : (
	CreateClassEnum,
	CreateClassEnumResponse
	),10 : (
	CreateClassEnumAsync,
	CreateClassEnumAsyncResponse
	),11 : (
	PutInstance,
	PutInstanceResponse
	),12 : (
	PutInstanceAsync,
	PutInstanceAsyncResponse
	),13 : (
	DeleteInstance,
	DeleteInstanceResponse
	),14 : (
	DeleteInstanceAsync,
	DeleteInstanceAsyncResponse
	),15 : (
	CreateInstanceEnum,
	CreateInstanceEnumResponse
	),16 : (
	CreateInstanceEnumAsync,
	CreateInstanceEnumAsyncResponse
	),17 : (
	ExecQuery,
	ExecQueryResponse
	),18 : (
	ExecQueryAsync,
	ExecQueryAsyncResponse
	),19 : (
	ExecNotificationQuery,
	ExecNotificationQueryResponse
	),20 : (
	ExecNotificationQueryAsync,
	ExecNotificationQueryAsyncResponse
	),21 : (
	ExecMethod,
	ExecMethodResponse
	),22 : (
...
OPNUMS = {0 : (
	...
	AddObjectToRefresherResponse
	),1 : (
	AddObjectToRefresherByTemplate,
	AddObjectToRefresherByTemplateResponse
	),2 : (
	AddEnumToRefresher,
	AddEnumToRefresherResponse
	),3 : (
	RemoveObjectFromRefresher,
	RemoveObjectFromRefresherResponse
	),4 : (
	GetRemoteRefresher,
	GetRemoteRefresherResponse
	),5 : (
	ReconnectRemoteRefresher,
	ReconnectRemoteRefresherResponse
	)}
#################################################################################
