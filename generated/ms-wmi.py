...
class SAFEARRAYUNION(NDRSTRUCT):
    structure = (
        ('sfType', UNSIGNED_LONG),('Anonymous32', ANONYMOUS32),
    )
...
class DATA_LONG(NDRUniConformantArray):
    item = BYTE

class PTR_LONG(NDRPOINTER):
    referent = (
        ('Data', DATA_LONG),
    )

class LONG(NDRSTRUCT):
    structure = (
	('m_lRequestId', LONG),	('m_lBlobType', WBEM_INSTANCE_BLOB_TYPE),	('m_lBlobLength', LONG),	('m_pbBlob', PTR_LONG),
