...
OPNUMS = {0 : (
	...
	EventObjectChangeEventClassIDResponse
	),4 : (
	QueryS,
	QuerySResponse
	),5 : (
...
OPNUMS = {0 : (
	EventClassID,
	EventClassIDResponse
	),1 : (
	EventClassName,
	EventClassNameResponse
	),2 : (
	OwnerSID,
	OwnerSIDResponse
	),3 : (
	FiringInterfaceID,
	FiringInterfaceIDResponse
	),4 : (
	Description,
	DescriptionResponse
	),5 : (
...
OPNUMS = {0 : (
	...
	MultiInterfacePublisherFilterCLSIDResponse
	),2 : (
	AllowInprocActivation,
	AllowInprocActivationResponse
	),3 : (
	FireInParallel,
	FireInParallelResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	SubscriberCLSID,
	SubscriberCLSIDResponse
	),6 : (
	SubscriberInterface,
	SubscriberInterfaceResponse
	),7 : (
	PerUser,
	PerUserResponse
	),8 : (
	...
	GetPublisherPropertyResponse
	),13 : (
	PutPublisherProperty,
	PutPublisherPropertyResponse
	),14 : (
	RemovePublisherProperty,
	RemovePublisherPropertyResponse
	),15 : (
	GetPublisherPropertyCollection,
	GetPublisherPropertyCollectionResponse
	),16 : (
	GetSubscriberProperty,
	GetSubscriberPropertyResponse
	),17 : (
	PutSubscriberProperty,
	PutSubscriberPropertyResponse
	),18 : (
	RemoveSubscriberProperty,
	RemoveSubscriberPropertyResponse
	),19 : (
	GetSubscriberPropertyCollection,
	GetSubscriberPropertyCollectionResponse
	),20 : (
	InterfaceID,
	InterfaceIDResponse
	)}
...
OPNUMS = {0 : (
	...
	EventClassPartitionIDResponse
	),1 : (
	EventClassApplicationID,
	EventClassApplicationIDResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	SubscriberPartitionIDResponse
	),3 : (
	SubscriberApplicationID,
	SubscriberApplicationIDResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	VerifyTransientSubscribersResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	SetCOMCatalogBehaviourResponse
	)}
