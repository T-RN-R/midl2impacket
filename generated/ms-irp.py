...
OPNUMS = {0 : (
	...
	R_InetInfoGetVersionResponse
	),1 : (
	R_InetInfoGetAdminInformation,
	R_InetInfoGetAdminInformationResponse
	),2 : (
	R_InetInfoGetSites,
	R_InetInfoGetSitesResponse
	),3 : (
	R_InetInfoSetAdminInformation,
	R_InetInfoSetAdminInformationResponse
	),4 : (
	R_InetInfoGetGlobalAdminInformation,
	R_InetInfoGetGlobalAdminInformationResponse
	),5 : (
	R_InetInfoSetGlobalAdminInformation,
	R_InetInfoSetGlobalAdminInformationResponse
	),6 : (
	R_InetInfoQueryStatistics,
	R_InetInfoQueryStatisticsResponse
	),7 : (
	R_InetInfoClearStatistics,
	R_InetInfoClearStatisticsResponse
	),8 : (
	R_InetInfoFlushMemoryCache,
	R_InetInfoFlushMemoryCacheResponse
	),9 : (
	R_InetInfoGetServerCapabilities,
	R_InetInfoGetServerCapabilitiesResponse
	),10 : (
	R_W3QueryStatistics2,
	R_W3QueryStatistics2Response
	),11 : (
	R_W3ClearStatistics2,
	R_W3ClearStatistics2Response
	),12 : (
	R_FtpQueryStatistics2,
	R_FtpQueryStatistics2Response
	),13 : (
	R_FtpClearStatistics2,
	R_FtpClearStatistics2Response
	),14 : (
	R_IISEnumerateUsers,
	R_IISEnumerateUsersResponse
	),15 : (
	R_IISDisconnectUser,
	R_IISDisconnectUserResponse
	),16 : (
