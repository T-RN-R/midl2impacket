...
OPNUMS = {0 : (
	...
	StartShadowCopySet,
	StartShadowCopySetResponse
	),3 : (
	AddToShadowCopySet,
	AddToShadowCopySetResponse
	),4 : (
	CommitShadowCopySet,
	CommitShadowCopySetResponse
	),5 : (
	ExposeShadowCopySet,
	ExposeShadowCopySetResponse
	),6 : (
	RecoveryCompleteShadowCopySet,
	RecoveryCompleteShadowCopySetResponse
	),7 : (
	AbortShadowCopySet,
	AbortShadowCopySetResponse
	),8 : (
	IsPathSupported,
	IsPathSupportedResponse
	),9 : (
	IsPathShadowCopied,
	IsPathShadowCopiedResponse
	),10 : (
	GetShareMapping,
	GetShareMappingResponse
	),11 : (
	DeleteShareMapping,
	DeleteShareMappingResponse
	),12 : (
