...
class U0(NDRUNION):
    union = {
        EvtRpcVarTypeNull: ('nullVal',INT),EvtRpcVarTypeBoolean: ('booleanVal',BOOLEAN),EvtRpcVarTypeUInt32: ('uint32Val',DWORD),EvtRpcVarTypeUInt64: ('uint64Val',DWORD64),EvtRpcVarTypeString: ('stringVal',LPWSTR),EvtRpcVarTypeGuid: ('guidVal',GUID),EvtRpcVarTypeBooleanArray: ('booleanArray',BOOLEANARRAY),EvtRpcVarTypeUInt32Array: ('uint32Array',UINT32ARRAY),EvtRpcVarTypeUInt64Array: ('uint64Array',UINT64ARRAY),EvtRpcVarTypeStringArray: ('stringArray',STRINGARRAY),EvtRpcVarTypeGuidArray: ('guidArray',GUIDARRAY),
    }
