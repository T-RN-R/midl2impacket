...
MACHINE_GROUP_MERGE_OPTIONS = DWORD__ENUM
...
OPNUMS = {0 : (
	RetrieveEventList,
	RetrieveEventListResponse
	),1 : (
	GetSystemAffinity,
	GetSystemAffinityResponse
	),2 : (
	ImportXMLFiles,
	ImportXMLFilesResponse
	),3 : (
	ExportXMLFiles,
	ExportXMLFilesResponse
	),4 : (
	RestoreXMLFiles,
	RestoreXMLFilesResponse
	),5 : (
	GetDependencies,
	...
	GetIISAppPoolNames,
	GetIISAppPoolNamesResponse
	),8 : (
	GetServerName,
	GetServerNameResponse
	),9 : (
	GetCurrentMemory,
	GetCurrentMemoryResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	GetCalendarInfo,
	GetCalendarInfoResponse
	),1 : (
	CreateCalendar,
	CreateCalendarResponse
	),2 : (
	ModifyCalendar,
	ModifyCalendarResponse
	),3 : (
	DeleteCalendar,
	DeleteCalendarResponse
	),4 : (
	RenameCalendar,
	RenameCalendarResponse
	),5 : (
	ComputeEvents,
	...
	MoveBeforeCalendar,
	MoveBeforeCalendarResponse
	),12 : (
	MoveAfterCalendar,
	MoveAfterCalendarResponse
	),13 : (
	GetServerTimeZone,
...
OPNUMS = {0 : (
	...
	RenameAllocationPolicyResponse
	),5 : (
	MoveBefore,
	MoveBeforeResponse
	),6 : (
	...
	SetCalDefaultPolicyNameResponse
	),8 : (
	GetCalDefaultPolicyName,
	GetCalDefaultPolicyNameResponse
	),9 : (
	GetProcessList,
	...
	SetCurrentPolicy,
	SetCurrentPolicyResponse
	),12 : (
	GetCurrentStateAndActivePolicyName,
	GetCurrentStateAndActivePolicyNameResponse
	),13 : (
	GetConditionalPolicy,
	GetConditionalPolicyResponse
	),14 : (
	SetConditionalPolicy,
	SetConditionalPolicyResponse
	)}
#################################################################################
...
class RenameResourceGroup(NDRCALL):
	...
	structure = (
			(
			'bstrNewResourceGroupName',
			BSTR
			),
			(
			'bstrOldResourceGroupName',
			BSTR
			)
		)
...
OPNUMS = {0 : (
	CreateAccountingDb,
	CreateAccountingDbResponse
	),1 : (
	GetAccountingMetadata,
	GetAccountingMetadataResponse
	),2 : (
	ExecuteAccountingQuery,
	ExecuteAccountingQueryResponse
	),3 : (
	GetRawAccountingData,
	GetRawAccountingDataResponse
	),4 : (
	GetNextAccountingDataBatch,
	GetNextAccountingDataBatchResponse
	),5 : (
	DeleteAccountingData,
	DeleteAccountingDataResponse
	),6 : (
	DefragmentDB,
	DefragmentDBResponse
	),7 : (
	CancelAccountingQuery,
	CancelAccountingQueryResponse
	),8 : (
	RegisterAccountingClient,
	RegisterAccountingClientResponse
	),9 : (
	DumpAccountingData,
	DumpAccountingDataResponse
	),10 : (
	GetAccountingClients,
	GetAccountingClientsResponse
	),11 : (
	SetAccountingClientStatus,
	SetAccountingClientStatusResponse
	),12 : (
	CheckAccountingConnection,
	CheckAccountingConnectionResponse
	),13 : (
	SetClientPermissions,
	SetClientPermissionsResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	GetExclusionList,
	GetExclusionListResponse
	),5 : (
	SetExclusionList,
	SetExclusionListResponse
	),6 : (
	WSRMActivate,
	WSRMActivateResponse
	),7 : (
	IsWSRMActivated,
	IsWSRMActivatedResponse
	),8 : (
	RestoreExclusionList,
	RestoreExclusionListResponse
	)}
#################################################################################
...
class CreateMachineGroup(NDRCALL):
	...
	structure = (
			(
			'bstrParentMachineGroupId',
			BSTR
			),
			(
			'bstrMachineGroupInfo',
			BSTR
			)
		)
...
class RenameMachineGroup(NDRCALL):
	...
	structure = (
			(
			'bstrOldMachineGroupName',
			BSTR
			),
			(
			'bstrNewMachineGroupName',
			BSTR
			)
		)
...
OPNUMS = {0 : (
	...
	GetRemoteUserCategoriesResponse
	),1 : (
	SetRemoteUserCategories,
	SetRemoteUserCategoriesResponse
	),2 : (
	RefreshRemoteSessionWeights,
	RefreshRemoteSessionWeightsResponse
	)}
