...
class S_DSQMGetObjectSecurityChallengeResponceProc(NDRCALL):
	...
	structure = (
			...
			(
			'pdwCallengeResponceSize',
			UNSIGNED_LONG
			),
			(
			'dwCallengeResponceMaxSize',
			UNSIGNED_LONG
			)
		)
...
OPNUMS = {0 : (
	S_DSCreateObject,
	S_DSCreateObjectResponse
	),1 : (
	S_DSDeleteObject,
	S_DSDeleteObjectResponse
	),2 : (
	S_DSGetProps,
	S_DSGetPropsResponse
	),3 : (
	S_DSSetProps,
	S_DSSetPropsResponse
	),4 : (
	S_DSGetObjectSecurity,
	S_DSGetObjectSecurityResponse
	),5 : (
	S_DSSetObjectSecurity,
	S_DSSetObjectSecurityResponse
	),6 : (
	S_DSLookupBegin,
	S_DSLookupBeginResponse
	),7 : (
	S_DSLookupNext,
	S_DSLookupNextResponse
	),8 : (
	S_DSLookupEnd,
	S_DSLookupEndResponse
	),9 : (
	Opnum9NotUsedOnWire,
	Opnum9NotUsedOnWireResponse
	),10 : (
	S_DSDeleteObjectGuid,
	S_DSDeleteObjectGuidResponse
	),11 : (
	S_DSGetPropsGuid,
	S_DSGetPropsGuidResponse
	),12 : (
	S_DSSetPropsGuid,
	S_DSSetPropsGuidResponse
	),13 : (
	S_DSGetObjectSecurityGuid,
	S_DSGetObjectSecurityGuidResponse
	),14 : (
	S_DSSetObjectSecurityGuid,
	S_DSSetObjectSecurityGuidResponse
	),15 : (
	...
	S_DSQMSetMachinePropertiesResponse
	),20 : (
	S_DSCreateServersCache,
	S_DSCreateServersCacheResponse
	),21 : (
	S_DSQMSetMachinePropertiesSignProc,
	S_DSQMSetMachinePropertiesSignProcResponse
	),22 : (
	S_DSQMGetObjectSecurity,
	S_DSQMGetObjectSecurityResponse
	),23 : (
	S_DSQMGetObjectSecurityChallengeResponceProc,
	S_DSQMGetObjectSecurityChallengeResponceProcResponse
	),24 : (
	S_InitSecCtx,
	S_InitSecCtxResponse
	),25 : (
	S_DSValidateServer,
	S_DSValidateServerResponse
	),26 : (
	S_DSCloseServerHandle,
	S_DSCloseServerHandleResponse
	),27 : (
...
OPNUMS = {0 : (
	...
	S_DSGetComputerSitesResponse
	),1 : (
	S_DSGetPropsEx,
	S_DSGetPropsExResponse
	),2 : (
	S_DSGetPropsGuidEx,
	S_DSGetPropsGuidExResponse
	),3 : (
	S_DSBeginDeleteNotification,
	S_DSBeginDeleteNotificationResponse
	),4 : (
	S_DSNotifyDelete,
	S_DSNotifyDeleteResponse
	),5 : (
	S_DSEndDeleteNotification,
	S_DSEndDeleteNotificationResponse
	),6 : (
	S_DSIsServerGC,
	S_DSIsServerGCResponse
	),7 : (
	Opnum7NotUsedOnWire,
	Opnum7NotUsedOnWireResponse
	),8 : (
	S_DSGetGCListInDomain,
	S_DSGetGCListInDomainResponse
	)}
