...
VSS_SNAPSHOT_STATE = DWORD__ENUM
VSS_SS_UNKNOWN = 0
VSS_SS_CREATED = 12
VSS_VOLUME_SNAPSHOT_ATTRIBUTES = DWORD__ENUM
...
OPNUMS = {0 : (
	...
	GetProviderMgmtInterfaceResponse
	),1 : (
	QueryVolumesSupportedForSnapshots,
	QueryVolumesSupportedForSnapshotsResponse
	),2 : (
...
OPNUMS = {0 : (
	...
	ChangeDiffAreaMaximumSizeResponse
	),2 : (
	QueryVolumesSupportedForDiffAreas,
	QueryVolumesSupportedForDiffAreasResponse
	),3 : (
	QueryDiffAreasForVolume,
	QueryDiffAreasForVolumeResponse
	),4 : (
	QueryDiffAreasOnVolume,
	QueryDiffAreasOnVolumeResponse
	),5 : (
	Opnum08NotUsedOnWire,
	Opnum08NotUsedOnWireResponse
	)}
#################################################################################
#IVssEnumObject Definition
#################################################################################
