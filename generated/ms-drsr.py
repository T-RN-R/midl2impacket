...
class PTR_DS_REPL_VALUE_META_DATA_2(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_DS_REPL_VALUE_META_DATA_2
			)
		)
...
REVERSE_MEMBERSHIP_OPERATION_TYPE = DWORD__ENUM
...
class PTR_DRS_MSG_NT4_CHGLOG_REQ_V1(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_DRS_MSG_NT4_CHGLOG_REQ_V1
			)
		)
...
class PTR_DRS_MSG_NT4_CHGLOG_REPLY_V1(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_DRS_MSG_NT4_CHGLOG_REPLY_V1
			)
		)
...
class DRS_MSG_NT4_CHGLOG_REPLY_V1(NDRSTRUCT):
	...
	structure = (
			...
			(
			'pLog',
			PTR_DRS_MSG_NT4_CHGLOG_REPLY_V1
			)
		)
...
class PTR_DRS_MSG_DCINFOREPLY_VFFFFFFFF(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_DRS_MSG_DCINFOREPLY_VFFFFFFFF
			)
		)
...
class DRS_MSG_DCINFOREPLY_VFFFFFFFF(NDRSTRUCT):
	...
	structure = (
			...
			(
			'rItems',
			PTR_DRS_MSG_DCINFOREPLY_VFFFFFFFF
			)
		)
...
class DRS_MSG_ADDSIDREQ_V1(NDRSTRUCT):
	...
	structure = (
			...
			(
			'SrcCredsPasswordLength',
			DWORD
			),
			(
			'SrcCredsPassword',
			PTR_DRS_MSG_ADDSIDREQ_V1
			),
			(
			'DstDomain',
			WCHAR
...
class PTR_DRS_MSG_GETMEMBERSHIPS2_REQ_V1(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_DRS_MSG_GETMEMBERSHIPS2_REQ_V1
			)
		)
...
class DRS_MSG_GETMEMBERSHIPS2_REQ_V1(NDRSTRUCT):
	...
	structure = (
			...
			(
			'Requests',
			PTR_DRS_MSG_GETMEMBERSHIPS2_REQ_V1
			)
		)
...
class PTR_DRS_MSG_GETMEMBERSHIPS2_REPLY_V1(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_DRS_MSG_GETMEMBERSHIPS2_REPLY_V1
			)
		)
...
class DRS_MSG_GETMEMBERSHIPS2_REPLY_V1(NDRSTRUCT):
	...
	structure = (
			...
			(
			'Replies',
			PTR_DRS_MSG_GETMEMBERSHIPS2_REPLY_V1
			)
		)
...
class PTR_DRS_MSG_QUERYSITESREPLY_V1(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_DRS_MSG_QUERYSITESREPLY_V1
			)
		)
...
class DRS_MSG_QUERYSITESREPLY_V1(NDRSTRUCT):
	...
	structure = (
			...
			(
			'rgCostInfo',
			PTR_DRS_MSG_QUERYSITESREPLY_V1
			),
			(
			'dwFlags',
			DWORD
...
class PTR_DRS_MSG_ADDCLONEDCREPLY_V1(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_DRS_MSG_ADDCLONEDCREPLY_V1
			)
		)
...
class DRS_MSG_ADDCLONEDCREPLY_V1(NDRSTRUCT):
	...
	structure = (
			...
			PTR_DRS_MSG_ADDCLONEDCREPLY_V1
			)
		)
...
class PTR_DRS_MSG_WRITENGCKEYREQ_V1(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_DRS_MSG_WRITENGCKEYREQ_V1
			)
		)
...
class PTR_DRS_MSG_READNGCKEYREPLY_V1(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_DRS_MSG_READNGCKEYREPLY_V1
			)
		)
...
class DRS_MSG_READNGCKEYREPLY_V1(NDRSTRUCT):
	...
	structure = (
			...
			(
			'pNgcKey',
			PTR_DRS_MSG_READNGCKEYREPLY_V1
			)
		)
...
OPNUMS = {0 : (
	...
	IDL_DRSUnbind,
	IDL_DRSUnbindResponse
	),2 : (
	IDL_DRSReplicaSync,
	IDL_DRSReplicaSyncResponse
	),3 : (
	IDL_DRSGetNCChanges,
	IDL_DRSGetNCChangesResponse
	),4 : (
	IDL_DRSUpdateRefs,
	IDL_DRSUpdateRefsResponse
	),5 : (
	IDL_DRSReplicaAdd,
	IDL_DRSReplicaAddResponse
	),6 : (
	IDL_DRSReplicaDel,
	IDL_DRSReplicaDelResponse
	),7 : (
	IDL_DRSReplicaModify,
	IDL_DRSReplicaModifyResponse
	),8 : (
	IDL_DRSVerifyNames,
	IDL_DRSVerifyNamesResponse
	),9 : (
	IDL_DRSGetMemberships,
	IDL_DRSGetMembershipsResponse
	),10 : (
	IDL_DRSInterDomainMove,
	IDL_DRSInterDomainMoveResponse
	),11 : (
	IDL_DRSGetNT4ChangeLog,
	IDL_DRSGetNT4ChangeLogResponse
	),12 : (
	IDL_DRSCrackNames,
	IDL_DRSCrackNamesResponse
	),13 : (
	IDL_DRSWriteSPN,
	IDL_DRSWriteSPNResponse
	),14 : (
	IDL_DRSRemoveDsServer,
	IDL_DRSRemoveDsServerResponse
	),15 : (
	IDL_DRSRemoveDsDomain,
	IDL_DRSRemoveDsDomainResponse
	),16 : (
	IDL_DRSDomainControllerInfo,
	IDL_DRSDomainControllerInfoResponse
	),17 : (
	IDL_DRSAddEntry,
	IDL_DRSAddEntryResponse
	),18 : (
	IDL_DRSExecuteKCC,
	IDL_DRSExecuteKCCResponse
	),19 : (
	IDL_DRSGetReplInfo,
	IDL_DRSGetReplInfoResponse
	),20 : (
	IDL_DRSAddSidHistory,
	IDL_DRSAddSidHistoryResponse
	),21 : (
	IDL_DRSGetMemberships2,
	IDL_DRSGetMemberships2Response
	),22 : (
	IDL_DRSReplicaVerifyObjects,
	IDL_DRSReplicaVerifyObjectsResponse
	),23 : (
	IDL_DRSGetObjectExistence,
	IDL_DRSGetObjectExistenceResponse
	),24 : (
	IDL_DRSQuerySitesByCost,
	IDL_DRSQuerySitesByCostResponse
	),25 : (
	IDL_DRSInitDemotion,
	IDL_DRSInitDemotionResponse
	),26 : (
	IDL_DRSReplicaDemotion,
	IDL_DRSReplicaDemotionResponse
	),27 : (
	IDL_DRSFinishDemotion,
	IDL_DRSFinishDemotionResponse
	),28 : (
	IDL_DRSAddCloneDC,
	IDL_DRSAddCloneDCResponse
	),29 : (
	IDL_DRSWriteNgcKey,
	IDL_DRSWriteNgcKeyResponse
	),30 : (
	IDL_DRSReadNgcKey,
	IDL_DRSReadNgcKeyResponse
	)}
#################################################################################
#dsaop Definition
#################################################################################
...
class PTR_DSA_MSG_EXECUTE_SCRIPT_REQ_V1(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_DSA_MSG_EXECUTE_SCRIPT_REQ_V1
			)
		)
...
class DSA_MSG_EXECUTE_SCRIPT_REQ_V1(NDRSTRUCT):
	...
	structure = (
			...
			(
			'pbPassword',
			PTR_DSA_MSG_EXECUTE_SCRIPT_REQ_V1
			)
		)
...
class PTR_DSA_MSG_PREPARE_SCRIPT_REPLY_V1(NDRPOINTER):
	referent = (
			(
			'Data',
			DATA_DSA_MSG_PREPARE_SCRIPT_REPLY_V1
			)
		)
...
class DSA_MSG_PREPARE_SCRIPT_REPLY_V1(NDRSTRUCT):
	...
	structure = (
			...
			(
			'pbHashSignature',
			PTR_DSA_MSG_PREPARE_SCRIPT_REPLY_V1
			)
		)
...
OPNUMS = {0 : (
	...
	IDL_DSAPrepareScriptResponse
	),1 : (
	IDL_DSAExecuteScript,
	IDL_DSAExecuteScriptResponse
	)}
