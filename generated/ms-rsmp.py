...
NtmsNotificationOperations = DWORD__ENUM
NTMS_OBJ_UPDATE = 1
NTMS_OBJ_INSERT = 2
NTMS_OBJ_DELETE = 3
NTMS_EVENT_SIGNAL = 4
NTMS_EVENT_COMPLETE = 5
NtmsDismountOptions = DWORD__ENUM
NTMS_DISMOUNT_DEFERRED = 1
NTMS_DISMOUNT_IMMEDIATE = 2
NtmsLmState = DWORD__ENUM
NTMS_LM_QUEUED = 0
NTMS_LM_INPROCESS = 1
NTMS_LM_PASSED = 2
NTMS_LM_FAILED = 3
...
NTMS_LM_CANCELLED = 7
NTMS_LM_STOPPED = 8
NtmsEjectOperation = DWORD__ENUM
NTMS_EJECT_START = 0
NTMS_EJECT_STOP = 1
NTMS_EJECT_QUEUE = 2
NTMS_EJECT_FORCE = 3
...
NtmsInjectOperation = DWORD__ENUM
NTMS_INJECT_START = 0
NTMS_INJECT_STOP = 1
NTMS_INJECT_RETRACT = 2
NTMS_INJECT_STARTMANY = 3
NtmsInventoryMethod = DWORD__ENUM
...
NtmsAllocateOptions = DWORD__ENUM
NTMS_ALLOCATE_NEW = 1
NTMS_ALLOCATE_NEXT = 2
NTMS_ALLOCATE_ERROR_IF_UNAVAILABLE = 4
NtmsCreateOptions = DWORD__ENUM
NTMS_OPEN_EXISTING = 1
NTMS_CREATE_NEW = 2
NTMS_OPEN_ALWAYS = 3
NtmsMountOptions = DWORD__ENUM
NTMS_MOUNT_READ = 1
NTMS_MOUNT_WRITE = 2
...
NtmsBarCodeState = DWORD__ENUM
NTMS_BARCODESTATE_OK = 1
NTMS_BARCODESTATE_UNREADABLE = 2
NtmsDriveState = DWORD__ENUM
...
NtmsOperationalState = DWORD__ENUM
NTMS_READY = 0
NTMS_INITIALIZING = 10
NTMS_NEEDS_SERVICE = 20
NTMS_NOT_PRESENT = 21
NtmsOpreqState = DWORD__ENUM
...
NtmsPartitionState = DWORD__ENUM
...
NtmsUIOperations = DWORD__ENUM
NTMS_UIDEST_ADD = 1
NTMS_UIDEST_DELETE = 2
NTMS_UIDEST_DELETEALL = 3
NtmsUITypes = DWORD__ENUM
NTMS_UITYPE_INVALID = 0
NTMS_UITYPE_INFO = 1
NTMS_UITYPE_REQ = 2
NTMS_UITYPE_ERR = 3
NTMS_UITYPE_MAX = 4
NtmsAccessMask = DWORD__ENUM
NTMS_USE_ACCESS = 1
...
OPNUMS = {0 : (
	EjectNtmsMedia,
	EjectNtmsMediaResponse
	),1 : (
	InjectNtmsMedia,
	InjectNtmsMediaResponse
	),2 : (
	AccessNtmsLibraryDoor,
	AccessNtmsLibraryDoorResponse
	),3 : (
	CleanNtmsDrive,
	CleanNtmsDriveResponse
	),4 : (
	DismountNtmsDrive,
	DismountNtmsDriveResponse
	),5 : (
	InventoryNtmsLibrary,
	InventoryNtmsLibraryResponse
	),6 : (
	INtmsLibraryControl1_LocalOnlyOpnum09,
	INtmsLibraryControl1_LocalOnlyOpnum09Response
	),7 : (
	CancelNtmsLibraryRequest,
	CancelNtmsLibraryRequestResponse
	),8 : (
	ReserveNtmsCleanerSlot,
	ReserveNtmsCleanerSlotResponse
	),9 : (
	ReleaseNtmsCleanerSlot,
	ReleaseNtmsCleanerSlotResponse
	),10 : (
	InjectNtmsCleaner,
	InjectNtmsCleanerResponse
	),11 : (
	EjectNtmsCleaner,
	EjectNtmsCleanerResponse
	),12 : (
	DeleteNtmsLibrary,
	DeleteNtmsLibraryResponse
	),13 : (
	DeleteNtmsDrive,
	DeleteNtmsDriveResponse
	),14 : (
	GetNtmsRequestOrder,
	GetNtmsRequestOrderResponse
	),15 : (
	SetNtmsRequestOrder,
	SetNtmsRequestOrderResponse
	),16 : (
	DeleteNtmsRequests,
	DeleteNtmsRequestsResponse
	),17 : (
	BeginNtmsDeviceChangeDetection,
	BeginNtmsDeviceChangeDetectionResponse
	),18 : (
	SetNtmsDeviceChangeDetection,
	SetNtmsDeviceChangeDetectionResponse
	),19 : (
	EndNtmsDeviceChangeDetection,
	EndNtmsDeviceChangeDetectionResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	MountNtmsMedia,
	MountNtmsMediaResponse
	),1 : (
	DismountNtmsMedia,
	DismountNtmsMediaResponse
	),2 : (
	Opnum5NotUsedOnWire,
	Opnum5NotUsedOnWireResponse
	),3 : (
	AllocateNtmsMedia,
	AllocateNtmsMediaResponse
	),4 : (
	DeallocateNtmsMedia,
	DeallocateNtmsMediaResponse
	),5 : (
	SwapNtmsMedia,
	SwapNtmsMediaResponse
	),6 : (
	DecommissionNtmsMedia,
	DecommissionNtmsMediaResponse
	),7 : (
	SetNtmsMediaComplete,
	SetNtmsMediaCompleteResponse
	),8 : (
	DeleteNtmsMedia,
	DeleteNtmsMediaResponse
	),9 : (
	CreateNtmsMediaPoolA,
	CreateNtmsMediaPoolAResponse
	),10 : (
	CreateNtmsMediaPoolW,
	CreateNtmsMediaPoolWResponse
	),11 : (
	GetNtmsMediaPoolNameA,
	GetNtmsMediaPoolNameAResponse
	),12 : (
	GetNtmsMediaPoolNameW,
	GetNtmsMediaPoolNameWResponse
	),13 : (
	MoveToNtmsMediaPool,
	MoveToNtmsMediaPoolResponse
	),14 : (
	DeleteNtmsMediaPool,
	DeleteNtmsMediaPoolResponse
	),15 : (
	AddNtmsMediaType,
	AddNtmsMediaTypeResponse
	),16 : (
	DeleteNtmsMediaType,
	DeleteNtmsMediaTypeResponse
	),17 : (
	ChangeNtmsMediaType,
	ChangeNtmsMediaTypeResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	GetNtmsServerObjectInformationA,
	GetNtmsServerObjectInformationAResponse
	),1 : (
	GetNtmsServerObjectInformationW,
	GetNtmsServerObjectInformationWResponse
	),2 : (
	SetNtmsObjectInformationA,
	SetNtmsObjectInformationAResponse
	),3 : (
	SetNtmsObjectInformationW,
	SetNtmsObjectInformationWResponse
	),4 : (
	CreateNtmsMediaA,
	CreateNtmsMediaAResponse
	),5 : (
	CreateNtmsMediaW,
	CreateNtmsMediaWResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	GetNtmsObjectSecurityResponse
	),1 : (
	SetNtmsObjectSecurity,
	SetNtmsObjectSecurityResponse
	),2 : (
	GetNtmsObjectAttributeA,
	GetNtmsObjectAttributeAResponse
	),3 : (
	GetNtmsObjectAttributeW,
	GetNtmsObjectAttributeWResponse
	),4 : (
	SetNtmsObjectAttributeA,
	SetNtmsObjectAttributeAResponse
	),5 : (
	SetNtmsObjectAttributeW,
	SetNtmsObjectAttributeWResponse
	),6 : (
	EnumerateNtmsObject,
	EnumerateNtmsObjectResponse
	),7 : (
	DisableNtmsObject,
	DisableNtmsObjectResponse
	),8 : (
	EnableNtmsObject,
	EnableNtmsObjectResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	OpenNtmsServerSessionWResponse
	),1 : (
	OpenNtmsServerSessionA,
	OpenNtmsServerSessionAResponse
	),2 : (
	CloseNtmsSession,
	CloseNtmsSessionResponse
	),3 : (
	SubmitNtmsOperatorRequestW,
	SubmitNtmsOperatorRequestWResponse
	),4 : (
	SubmitNtmsOperatorRequestA,
	SubmitNtmsOperatorRequestAResponse
	),5 : (
	WaitForNtmsOperatorRequest,
	WaitForNtmsOperatorRequestResponse
	),6 : (
	CancelNtmsOperatorRequest,
	CancelNtmsOperatorRequestResponse
	),7 : (
	SatisfyNtmsOperatorRequest,
	SatisfyNtmsOperatorRequestResponse
	),8 : (
	ImportNtmsDatabase,
	ImportNtmsDatabaseResponse
	),9 : (
	ExportNtmsDatabase,
	ExportNtmsDatabaseResponse
	),10 : (
...
OPNUMS = {0 : (
	...
	EnumerateNtmsObjectRResponse
	),1 : (
	GetNtmsUIOptionsA,
	GetNtmsUIOptionsAResponse
	),2 : (
	GetNtmsUIOptionsW,
	GetNtmsUIOptionsWResponse
	),3 : (
	SetNtmsUIOptionsA,
	SetNtmsUIOptionsAResponse
	),4 : (
	SetNtmsUIOptionsW,
	SetNtmsUIOptionsWResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	GetNtmsObjectAttributeAR,
	GetNtmsObjectAttributeARResponse
	),1 : (
	GetNtmsObjectAttributeWR,
	GetNtmsObjectAttributeWRResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	GetNtmsMediaPoolNameAR,
	GetNtmsMediaPoolNameARResponse
	),1 : (
	GetNtmsMediaPoolNameWR,
	GetNtmsMediaPoolNameWRResponse
	)}
#################################################################################
#IUnknown Definition
#################################################################################
