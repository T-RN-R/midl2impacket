...
OPNUMS = {0 : (
	...
	EnumViewColumn,
	EnumViewColumnResponse
	),9 : (
	GetViewDefaultColumnSet,
	GetViewDefaultColumnSetResponse
	),10 : (
	EnumAttributesOrExtensions,
	EnumAttributesOrExtensionsResponse
	),11 : (
	OpenView,
	OpenViewResponse
	),12 : (
	...
	BackupGetAttachmentInformationResponse
	),20 : (
	BackupGetBackupLogs,
	BackupGetBackupLogsResponse
	),21 : (
	BackupOpenFile,
	BackupOpenFileResponse
	),22 : (
	BackupReadFile,
	BackupReadFileResponse
	),23 : (
	BackupCloseFile,
	BackupCloseFileResponse
	),24 : (
	BackupTruncateLogs,
	BackupTruncateLogsResponse
	),25 : (
	ImportCertificate,
	ImportCertificateResponse
	),26 : (
	BackupGetDynamicFiles,
	BackupGetDynamicFilesResponse
	),27 : (
	RestoreGetDatabaseLocations,
	RestoreGetDatabaseLocationsResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	GetCAProperty,
	GetCAPropertyResponse
	),2 : (
	SetCAProperty,
	SetCAPropertyResponse
	),3 : (
	GetCAPropertyInfo,
	GetCAPropertyInfoResponse
	),4 : (
	EnumViewColumnTable,
	EnumViewColumnTableResponse
	),5 : (
	GetCASecurity,
	GetCASecurityResponse
	),6 : (
	SetCASecurity,
	SetCASecurityResponse
	),7 : (
	Ping2,
	Ping2Response
	),8 : (
	GetArchivedKey,
	GetArchivedKeyResponse
	),9 : (
	GetAuditFilter,
	GetAuditFilterResponse
	),10 : (
	SetAuditFilter,
	SetAuditFilterResponse
	),11 : (
	GetOfficerRights,
	GetOfficerRightsResponse
	),12 : (
	SetOfficerRights,
	SetOfficerRightsResponse
	),13 : (
	GetConfigEntry,
	GetConfigEntryResponse
	),14 : (
	SetConfigEntry,
	SetConfigEntryResponse
	),15 : (
	ImportKey,
	ImportKeyResponse
	),16 : (
