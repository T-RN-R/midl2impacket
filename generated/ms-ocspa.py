...
class CERTTRANSBLOB(NDRSTRUCT):
    structure = (
	('cb', UNSIGNED_LONG),	('pb', PTR_CERTTRANSBLOB),
...
OPNUMS = {
0 : (GetOCSPProperty,GetOCSPPropertyResponse),
1 : (SetOCSPProperty,SetOCSPPropertyResponse),
2 : (GetCAConfigInformation,GetCAConfigInformationResponse),
3 : (SetCAConfigInformation,SetCAConfigInformationResponse),
4 : (GetSecurity,GetSecurityResponse),
5 : (SetSecurity,SetSecurityResponse),
6 : (GetSigningCertificates,GetSigningCertificatesResponse),
7 : (GetHashAlgorithms,GetHashAlgorithmsResponse),
8 : (GetMyRoles,GetMyRolesResponse),
9 : (Ping,PingResponse),
}
