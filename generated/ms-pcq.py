...
#################################################################################
MSRPC_UUID_PERFLIBV2 = uuidtup_to_bin(('da5a86c5-122-4943-ab30-774813853','0.0'))
RPC_HQUERY = HANDLE
...
OPNUMS = {0 : (
	...
	PerflibV2EnumerateCounterSetResponse
	),1 : (
	PerflibV2QueryCounterSetRegistrationInfo,
	PerflibV2QueryCounterSetRegistrationInfoResponse
	),2 : (
	PerflibV2EnumerateCounterSetInstances,
	PerflibV2EnumerateCounterSetInstancesResponse
	),3 : (
	PerflibV2OpenQueryHandle,
	PerflibV2OpenQueryHandleResponse
	),4 : (
	PerflibV2CloseQueryHandle,
	PerflibV2CloseQueryHandleResponse
	),5 : (
	PerflibV2QueryCounterInfo,
	PerflibV2QueryCounterInfoResponse
	),6 : (
	PerflibV2QueryCounterData,
	PerflibV2QueryCounterDataResponse
	),7 : (
	PerflibV2ValidateCounters,
	PerflibV2ValidateCountersResponse
	)}
