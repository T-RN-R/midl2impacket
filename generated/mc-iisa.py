...
OPNUMS = {0 : (
	...
	GetSiteNameFromSiteIdResponse
	),1 : (
	GetSiteIdFromSiteName,
	GetSiteIdFromSiteNameResponse
	),2 : (
	GetSiteElementFromSiteId,
	GetSiteElementFromSiteIdResponse
	),3 : (
	MapPath,
	MapPathResponse
	)}
...
OPNUMS = {0 : (
	...
	ValidationParameter,
	ValidationParameterResponse
	),9 : (
	GetMetadata,
	GetMetadataResponse
	),10 : (
	IsCaseSensitive,
	IsCaseSensitiveResponse
	),11 : (
	PossibleValues,
	PossibleValuesResponse
	),12 : (
	DoesAllowInfinite,
	DoesAllowInfiniteResponse
	),13 : (
	IsEncrypted,
	IsEncryptedResponse
	),14 : (
	TimeSpanFormat,
	TimeSpanFormatResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	AddElementNames,
	AddElementNamesResponse
	),1 : (
	GetAddElementSchema,
	GetAddElementSchemaResponse
	),2 : (
	RemoveElementSchema,
	RemoveElementSchemaResponse
	),3 : (
	ClearElementSchema,
	ClearElementSchemaResponse
	),4 : (
	IsMergeAppend,
	IsMergeAppendResponse
	),5 : (
	GetMetadata,
	GetMetadataResponse
	),6 : (
	DoesAllowDuplicates,
	DoesAllowDuplicatesResponse
	)}
#################################################################################
#IAppHostElementSchema Definition
#################################################################################
...
OPNUMS = {0 : (
	...
	DoesAllowUnschematizedPropertiesResponse
	),2 : (
	GetMetadata,
	GetMetadataResponse
	),3 : (
	...
	ChildElementSchemas,
	ChildElementSchemasResponse
	),5 : (
	PropertySchemas,
	PropertySchemasResponse
	),6 : (
	IsCollectionDefault,
	IsCollectionDefaultResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	PreErrorLine,
	PreErrorLineResponse
	),5 : (
	PostErrorLine,
	PostErrorLineResponse
	),6 : (
	ErrorString,
	ErrorStringResponse
	)}
...
OPNUMS = {0 : (
	...
	ValidationFailureReasonResponse
	),2 : (
	ValidationFailureParameters,
	ValidationFailureParametersResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	GetElementByName,
	GetElementByNameResponse
	),8 : (
	GetPropertyByName,
	GetPropertyByNameResponse
	),9 : (
	Clear,
	ClearResponse
	),10 : (
...
OPNUMS = {0 : (
	...
	OverrideModeDefault,
	OverrideModeDefaultResponse
	),3 : (
	AllowDefinition,
	AllowDefinitionResponse
	),4 : (
	AllowLocation,
	AllowLocationResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	AddSectionGroup,
	AddSectionGroupResponse
	),4 : (
	DeleteSectionGroup,
	DeleteSectionGroupResponse
	),5 : (
	Name,
	NameResponse
	),6 : (
...
OPNUMS = {0 : (
	...
	ClearInvalidSectionsResponse
	),7 : (
	RootSectionGroup,
	RootSectionGroupResponse
	)}
#################################################################################
