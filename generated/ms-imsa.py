...
OPNUMS = {0 : (
	...
	GetDataSetNumber,
	GetDataSetNumberResponse
	),21 : (
	SetLastChangeTime,
	SetLastChangeTimeResponse
	),22 : (
	GetLastChangeTime,
	GetLastChangeTimeResponse
	),23 : (
	R_KeyExchangePhase1,
	R_KeyExchangePhase1Response
	),24 : (
	R_KeyExchangePhase2,
	R_KeyExchangePhase2Response
	),25 : (
	Backup,
	BackupResponse
	),26 : (
	...
	UnmarshalInterface,
	UnmarshalInterfaceResponse
	),30 : (
	R_GetServerGuid,
	R_GetServerGuidResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	BackupWithPasswd,
	BackupWithPasswdResponse
	),1 : (
	RestoreWithPasswd,
	RestoreWithPasswdResponse
	),2 : (
	Export,
	ExportResponse
	),3 : (
...
OPNUMS = {0 : (
	...
	CreateApplicationPoolResponse
	),3 : (
	DeleteApplicationPool,
	DeleteApplicationPoolResponse
	),4 : (
	EnumerateApplicationsInPool,
	EnumerateApplicationsInPoolResponse
	),5 : (
	RecycleApplicationPool,
	RecycleApplicationPoolResponse
	),6 : (
	GetProcessMode,
	GetProcessModeResponse
	)}
#################################################################################
...
OPNUMS = {0 : (
	...
	IsInstalledRemote,
	IsInstalledRemoteResponse
	),6 : (
	Opnum13NotUsedOnWire,
	Opnum13NotUsedOnWireResponse
	),7 : (
	IsExportableRemote,
	IsExportableRemoteResponse
	),8 : (
	Opnum15NotUsedOnWire,
	Opnum15NotUsedOnWireResponse
	),9 : (
	GetCertInfoRemote,
	GetCertInfoRemoteResponse
	),10 : (
	...
	ImportFromBlob,
	ImportFromBlobResponse
	),16 : (
	ImportFromBlobGetHash,
	ImportFromBlobGetHashResponse
	),17 : (
	Opnum24NotUsedOnWire,
	Opnum24NotUsedOnWireResponse
	),18 : (
	ExportToBlob,
	ExportToBlobResponse
	)}
